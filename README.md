...
| x86     | Python3.11     | [link](https://download.pytorch.org/whl/cpu/torch-2.4.0%2Bcpu-cp311-cp311-linux_x86_64.whl#sha256=14a7a8b595347dddca594f9e448b93ce68ce4f871acbd32cf04bda7c03664c0c)                           |
...
| aarch64 | Python3.11     | [link](https://download.pytorch.org/whl/cpu/torch-2.4.0-cp311-cp311-manylinux_2_17_aarch64.manylinux2014_aarch64.whl#sha256=38169cb0f1e6727c3dac8dac8b9a48d072a49f643b908a99155ef1d81b61bdeb) |

3. **Install torch-npu**

```
pip3 install torch-npu==2.4.0.post3
```
...
1. **Clone torch-npu**
   ...
   ```
   git clone https://github.com/ascend/pytorch.git -b v2.4.0-7.0.0 --depth 1
   ```
