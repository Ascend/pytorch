...
1. **Clone torch-npu**
   ...
   ```
   git clone https://github.com/ascend/pytorch.git -b v1.11.0-6.0.rc2 --depth 1
   ```
...
| AscendPyTorch Network Model Migration and Training | [link](ttps://www.hiascend.com/document/detail/zh/Pytorch/60RC1/ptmoddevg/trainingmigrguide/PT_LMTMOG_0003.html) |
