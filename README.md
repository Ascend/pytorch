...
2. **Install TorchNPU dependencies**
    ...
    |---------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | x86     | Python3.10      | [link](https://download-r2.pytorch.org/whl/cpu/torch-2.12.0%2Bcpu-cp310-cp310-manylinux_2_28_x86_64.whl)                             |
    | x86     | Python3.11      | [link](https://download-r2.pytorch.org/whl/cpu/torch-2.12.0%2Bcpu-cp311-cp311-manylinux_2_28_x86_64.whl)                             |
    | x86     | Python3.12      | [link](https://download-r2.pytorch.org/whl/cpu/torch-2.12.0%2Bcpu-cp312-cp312-manylinux_2_28_x86_64.whl)                           |
    | aarch64 | Python3.10      | [link](https://download-r2.pytorch.org/whl/cpu/torch-2.12.0%2Bcpu-cp310-cp310-manylinux_2_28_aarch64.whl)   |
