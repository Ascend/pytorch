...
1. **Clone torch-npu**
   ...
   ```
   git clone https://github.com/ascend/pytorch.git -b v2.1.0-6.0.0 --depth 1
   ```
...
For more detailed information on installation guides, model migration, training/inference tutorials, and API lists, please refer to the [PyTorch Ascend Adapter on the HiAI Community](https://www.hiascend.com/software/ai-frameworks?framework=pytorch).
