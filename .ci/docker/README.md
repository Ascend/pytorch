...
| 类型 | 基座 | 用途 |
|------|------|------|
| **builder (x86_64)** | `pytorch/manylinux2_28-builder:cpu-2.7` | 编译构建 torch-npu wheel 包，包含完整编译工具链 |
| **builder (aarch64)** | `pytorch/manylinux2_28_aarch64-builder:cpu-aarch64-2.7` | 编译构建 torch-npu wheel 包，包含完整编译工具链 |
