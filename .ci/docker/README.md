...
| 类型 | 基座 | 用途 |
|------|------|------|
| **builder (x86_64)** | `pytorch/manylinux2_28-builder:cpu-v2.11.0-rc6` | 编译构建 torch-npu wheel 包，包含完整编译工具链 |
| **builder (aarch64)** | `pytorch/manylinux2_28_aarch64-builder:cpu-aarch64-v2.11.0-rc6` | 编译构建 torch-npu wheel 包，包含完整编译工具链 |
...
./docker_build.sh torch-npu-builder-aarch64-torch2.11.0

# Test 镜像 (含 CANN)
./docker_build.sh torch-npu-test-x86_64-cann-a1-py3.10-torch2.11.0
