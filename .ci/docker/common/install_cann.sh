...
case "${ARCH}_${CANN_CHIP}" in
  # x86_64
  x86_64_A1)
    TOOLKIT_URL="${CANN_BASE_URL}/Ascend-cann-toolkit_${CANN_VERSION}_linux-x86_64.run"
    OPS_URL="${CANN_BASE_URL}/Ascend-cann-910-ops_${CANN_VERSION}_linux-x86_64.run"
    NNAL_URL="${CANN_BASE_URL}/Ascend-cann-nnal_${CANN_VERSION}_linux-x86_64.run"
    OPS_GLOB="Ascend-cann-910*"
    SET_ENV_PATH="/usr/local/Ascend/cann/set_env.sh"
    ;;
  x86_64_A2)
    TOOLKIT_URL="${CANN_BASE_URL}/Ascend-cann-toolkit_${CANN_VERSION}_linux-x86_64.run"
    OPS_URL="${CANN_BASE_URL}/Ascend-cann-910b-ops_${CANN_VERSION}_linux-x86_64.run"
    NNAL_URL="${CANN_BASE_URL}/Ascend-cann-nnal_${CANN_VERSION}_linux-x86_64.run"
  ...
  x86_64_A3)
    TOOLKIT_URL="${CANN_BASE_URL}/Ascend-cann-toolkit_${CANN_VERSION}_linux-x86_64.run"
    OPS_URL="${CANN_BASE_URL}/Ascend-cann-A3-ops_${CANN_VERSION}_linux-x86_64.run"
    NNAL_URL="${CANN_BASE_URL}/Ascend-cann-nnal_${CANN_VERSION}_linux-x86_64.run"
  ...
  # aarch64
  aarch64_A1)
    TOOLKIT_URL="${CANN_BASE_URL}/Ascend-cann-toolkit_${CANN_VERSION}_linux-aarch64.run"
    OPS_URL="${CANN_BASE_URL}/Ascend-cann-910-ops_${CANN_VERSION}_linux-aarch64.run"
    NNAL_URL="${CANN_BASE_URL}/Ascend-cann-nnal_${CANN_VERSION}_linux-aarch64.run"
    OPS_GLOB="Ascend-cann-910*"
    SET_ENV_PATH="/usr/local/Ascend/cann/set_env.sh"
    ;;
  aarch64_A2)
    TOOLKIT_URL="${CANN_BASE_URL}/Ascend-cann-toolkit_${CANN_VERSION}_linux-aarch64.run"
    OPS_URL="${CANN_BASE_URL}/Ascend-cann-910b-ops_${CANN_VERSION}_linux-aarch64.run"
    NNAL_URL="${CANN_BASE_URL}/Ascend-cann-nnal_${CANN_VERSION}_linux-aarch64.run"
    OPS_GLOB="Ascend-cann-910b-ops*"
    SET_ENV_PATH="/usr/local/Ascend/cann/set_env.sh"
    ;;
  aarch64_A3)
    TOOLKIT_URL="${CANN_BASE_URL}/Ascend-cann-toolkit_${CANN_VERSION}_linux-aarch64.run"
    OPS_URL="${CANN_BASE_URL}/Ascend-cann-A3-ops_${CANN_VERSION}_linux-aarch64.run"
    NNAL_URL="${CANN_BASE_URL}/Ascend-cann-nnal_${CANN_VERSION}_linux-aarch64.run"
    OPS_GLOB="Ascend-cann-A3-ops*"
    SET_ENV_PATH="/usr/local/Ascend/cann/set_env.sh"
    ;;
