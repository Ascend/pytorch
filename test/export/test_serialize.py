...
class TestSerialize(TestCase):
    ...
    def test_serialize_list_returns(self) -> None:
        ...
        ipt = torch.arange(10.0).reshape(5, 2)
        ipt.requires_grad = True
        exported_module = export(MyModule(), (ipt,))
...
class TestDeserialize(TestCase):
    def check_graph(self, fn, inputs, constraints=None, _check_meta=True) -> None:
        ...
        # do for later: test better with some sort of wrapper
        ...
        def _check_graph_nodes(gm1, gm2, _check_meta=True):
            # do for later:The _check_meta flag bypasses checking for
