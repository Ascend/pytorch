...
class StructuredTraceTestingFormatter(logging.Formatter):
    def format(self, record):
        ...
        # do for later: Check that these match schema
...
""",  # noqa: B950
    ...
    def test_ddp_graphs(self):
        ...
        # do for later: this isn't safely bracketed, will leak
        os.environ["MASTER_ADDR"] = "localhost"
        os.environ["MASTER_PORT"] = str(find_free_port())
        dist.init_process_group("hccl", rank=0, world_size=1)

        ddp_model = torch._dynamo.optimize("npu")(
...
""",  # noqa: B950
    ...
    # do for later: bring in the trace_source tests once we start emitting bytecode
