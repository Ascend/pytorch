...
class AotAutogradFallbackTests(torch._dynamo.test_case.TestCase):
    def test_LSTM(self):
        # See pytorch/torchdynamo/issues/1147
    ...
    def test_mutation(self):
        # See pytorch/torchdynamo/issues/1301
        def fn(param, y):
    ...
    @expectedFailureDynamic  # See pytorch/pytorch/issues/103539
    ...
    def test_nn_parameter_construction(self):
        # See pytorch/pytorch/issues/99569
        def fn(x):
            y = x.sin()
...
"""
    ...
    # See pytorch/pytorch/issues/110121
