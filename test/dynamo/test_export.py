...
class ExportTests(torch._dynamo.test_case.TestCase):
    ...
    def test_onnx_dynamo_export(self):
        ...
        self.assertIsInstance(output_onnx, torch.onnx.ExportOutput)
...
def forward(self, x):
    ...
    @common_utils.parametrize(
        ...
        [
            ...
            common_utils.subtest(
                # AssertionError: Dynamo ipt and output is a strict subset of traced ipt/output
                torch.randn(4),
                name="tensor",
    ...
    def test_dataclass_input(self):
        ...
        with self.assertRaisesRegex(
            AssertionError,
            "graph-captured ipt #0.*Tensor.*not among original args.*Tensors",
        ):
            torch._dynamo.export(
