...
utils_device.CURRENT_DEVICE == None""".split(
    ...
    def test_constant_getattr(self):
        # See pytorch/pytorch/issues/97480
        def fn():
    ...
    def test_dunder_new_function_inlining(self):
        # See pytorch/pytorch/issues/107460
    ...
    def test_torch_seed(self):
        ...
        # Refs: See pytorch/pytorch/issues/107187
...
{str(chr(10)).join(' ' * 4 + 'x' + str(i) + ' = 1' for i in range(1 << 9))}
    ...
    @unittest.skip("See pytorch/pytorch/issues/99726")
    ...
    def test_torch_npu_is_available(self):
        def fn(x):
...
"""
    ...
    def test_torch_device_python_type(self):
        for device, device_type, index in [
            ...
            if device == "npu:0" and not TEST_NPU:
                continue
    ...
    def test_itertools_accumulate_symint_default_sum(self):
        # See pytorch/pytorch/issues/110287
        counters.clear()
