...
class TestConvolutionNN(NNTestCase):
    ...
    def test_grouped_conv_cudnn_nhwc_support(self):
        ...
        input1 = torch.randn((16, 16, 8, 8), dtype=torch.float16, device="cuda").to(memory_format=torch.channels_last)
        ...
        input1 = torch.randn((16, 8, 8, 8), dtype=torch.float16, device="cuda").to(memory_format=torch.channels_last)
    ...
    def test_conv_cudnn_memory_layout_dominance(self):
        ...
        input1 = torch.randint(1, 10, (2, 8, 4, 4), dtype=torch.float32, device="cuda", requires_grad=True)
    ...
    def test_cudnn_noncontiguous_weight(self):
        ...
        # passed to cuDNN
        input1 = torch.tensor([1, 1, 1], dtype=torch.double, device="cuda").view(1, 1, 3)
...
class TestConvolutionNNDeviceType(NNTestCase):
    ...
    def test_conv_cudnn_nhwc_support(self, device, dtype):
        input1 = torch.randn((1, 16, 1, 1), dtype=dtype, device="cuda", requires_grad=True)
