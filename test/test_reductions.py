...
class TestReductions(TestCase):
    ...
    # (@heitorschueroff) combine cases with and without keepdim once
    ...
    # (@heitorschueroff) Update these to use the nan_policy kwarg once
    ...
    ###########################################################################
    # Legacy tests - port to ReductionOpInfo
    ###########################################################################
    ...
    # kill map2_ (and similar) uses and update to compare with NumPy
    ...
    # kill this ane replace with common creation ops
    ...
    # refactor this to use comparators from common_utils
    ...
    # update this and tests that use it to use the device argument properly
    ...
    # update this and tests that use it to handle device properly
    ...
    @expectedFailureMeta  # mode only supports CPU and npu device type
    ...
    # this should be a generic opinfo test
    ...
    # bincount isn't a classic reduction -- maybe this test suite is
    ...
    # how many var stability tests are there?
    ...
    # consider refactoring with bincount test
    ...
    # part of this test covers torch.norm, with should be covered by test_linalg
    ...
    # make this test generic using OpInfos
    ...
    def test_dim_reduction(self, device, dtype):
        ...
        # torch.min does not support the same operation as argmin
...
as the input tensor excluding its innermost dimension'):
    ...
    # can these be merged with their respective OpInfos?
    ...
    def test_reductions_large_half_tensors(self, device, dtype):
        ...
        # mean_npu is not implemented for ComplexHalf
