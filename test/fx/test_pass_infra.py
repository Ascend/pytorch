...
class TestPassManager(TestCase):
    ...
    def test_topological_sort(self):
        ...
        sort = _topological_sort_passes(passes, [])
        self.assertEqual(sort, passes)
        ...
        sort = _topological_sort_passes(passes, constraints)
        self.assertEqual(sort, [pass4, pass5, pass0, pass2, pass3, pass1])
