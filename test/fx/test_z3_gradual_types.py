...
class HFOperations(unittest.TestCase):
    ...
    def test_layer_norm(self):
        ...
        # in the migration of the input1

        b = BasicBlock().forward(torch.rand(1024))
        input1 = z3.Const(1, tensor_type)
        output = z3.Const(2, tensor_type)
        s.add(output == tensor_type.tensor1(D(1, 1024)))
        s.check()
        self.assertEqual(s.model()[input1], s.model()[output])
        # input1 shape = output shape
        self.assertEqual(b.shape[0], s.model()[input1].arg(0).arg(1))
    ...
    def test_ne_int_long_type_as(self):
        ...
        s.add(input1 == tensor_type.tensor2(D(1, 2), D(1, 4)))
    ...
    def test_ne(self):
        ...
        input1 = z3.Const(2, tensor_type)
        s.add(input1 == tensor_type.tensor2(d1, d2))
        self.assertEqual(s.check(), z3.sat)
    ...
    def test_size_two_args(self):
        ...
        self.assertEqual(s.check(), z3.sat)
        input1 = z3.Const(1, tensor_type)
        s.add(input1 == tensor_type.tensor3(D(3, 39), D(1, 2), D(d4, d5)))
    ...
    def test_size_getitem(self):
        ...
        input1 = z3.Const(1, tensor_type)
        s.add(input1 == tensor_type.tensor4(d1, d2, d3, d4))
...
class GradualTypes(unittest.TestCase):
    ...
    def test_conv_reshape0(self):
        ...
        input1 = z3.Const(1, tensor_type)
        solver.add(input1 == tensor_type.tensor4(d1, d2, d3, d4))
...
class TestSingleOperation(unittest.TestCase):
    ...
    def test_conv2D_maxpool2d_flatten(self):
        ...
        solver.check()
        input1 = z3.Const(1, tensor_type)
        solver.add(input1 == tensor_type.tensor4(D(1, 4), D(1, 3), D(1, 32), D(1, 32)))
        solver.check()
    ...
    def test_conv2D_maxpool2d_flatten_unsat(self):
        ...
        solver.check()
        input1 = z3.Const(1, tensor_type)
        solver.add(input1 == tensor_type.tensor4(D(1, 4), D(1, 3), D(1, 32), D(1, 45)))
        self.assertEqual(solver.check(), z3.unsat)
...
class TestResNet(unittest.TestCase):
    ...
    def test_resnet50_unsat(self):
        ...
        solver.add(constraints)
        input1 = z3.Const(1, tensor_type)
        # input1 with 3 dimensions
        solver.add(input1 == tensor_type.tensor3(D(1, 1), D(1, 3), D(1, 224)))
        self.assertEqual(solver.check(), z3.unsat)
    ...
    def test_resnet50(self):
        ...
        input1 = z3.Const(1, tensor_type)
        solver.add(input1 == tensor_type.tensor4(D(1, 1), D(1, 3), D(1, 224), D(1, 224)))
        self.assertEqual(solver.check(), z3.sat)
    ...
    def test_resnet502(self):
        ...
        input1 = z3.Const(1, tensor_type)
        batch = z3.Int('b')
        solver.add(input1 == tensor_type.tensor4(D(1, batch), D(1, 3), D(1, 224), D(1, 224)))
        solver.add(batch > 4)
        solver.check()
...
class TestAlexNet(unittest.TestCase):
    def test_alexnet1(self):
        ...
        solver.add(input1 == tensor_type.tensor4(D(1, 10), D(1, 3), D(1, 227), D(1, 227)))
        self.assertEqual(solver.check(), z3.sat)
