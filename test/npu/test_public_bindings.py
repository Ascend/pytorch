...
tempFilter = {
    ...
    "torch_npu.dynamo.torchair.inference.NoGuardCompiledFunction",
    "torch_npu.dynamo.torchair.inference.NoGuardCompiledMethod",
    "torch_npu.dynamo.torchair.inference.cache_compile",
    "torch_npu.dynamo.torchair.inference.get_dim_gears",
    "torch_npu.dynamo.torchair.inference.readable_cache",
    "torch_npu.dynamo.torchair.inference.set_dim_gears",
    "torch_npu.dynamo.torchair.inference.cache_compiler.Callable",
    "torch_npu.dynamo.torchair.inference.cache_compiler.CompilerConfig",
    "torch_npu.dynamo.torchair.inference.cache_compiler.Dict",
    "torch_npu.dynamo.torchair.inference.cache_compiler.List",
    "torch_npu.dynamo.torchair.inference.cache_compiler.Optional",
    "torch_npu.dynamo.torchair.inference.cache_compiler.Tuple",
    "torch_npu.dynamo.torchair.inference.cache_compiler.Union",
    "torch_npu.dynamo.torchair.inference.cache_compiler.aot_module_simplified",
    "torch_npu.dynamo.torchair.inference.cache_compiler.contextmanager",
    "torch_npu.dynamo.torchair.inference.cache_compiler.dataclass",
    "torch_npu.dynamo.torchair.utils.export_utils.GraphDef",
