...
tempFilter = {
    ...
    "torch_npu.profiler.analysis.prof_bean.node_info_bean._NodeInfoBean",
    ...
    "torch_npu.testing._internal.common_distributed.Any",
    "torch_npu.testing._internal.common_distributed.Dict",
    "torch_npu.testing._internal.common_distributed.Tuple",
    "torch_npu.testing._internal.common_distributed.namedtuple",
    "torch_npu.testing._internal.common_distributed.wraps",
    "torch_npu.testing._internal.common_methods_invocations.List",
    "torch_npu.testing._internal.common_methods_invocations.make_tensor",
    "torch_npu.testing._internal.common_methods_invocations.partial",
    "torch_npu.testing._internal.common_methods_invocations.sample_inputs_normal_common",
    "torch_npu.testing._internal.common_methods_invocations.wraps",
    "torch_npu.testing._internal.common_utils.List",
    "torch_npu.testing._internal.common_utils.PathManager",
    "torch_npu.testing._internal.common_utils.contextmanager",
    "torch_npu.testing._internal.common_utils.product",
    "torch_npu.testing._internal.common_utils.wraps",
    "torch_npu.testing._decorator.partialmethod",
    "torch_npu.testing._decorator.wraps",
    "torch_npu.testing._testcase.Number",
    "torch_npu.testing._testcase.OrderedDict",
    "torch_npu.testing._testcase.Sequence",
    "torch_npu.testing._testcase.TestResult",
    "torch_npu.testing._testcase.contextmanager",
    "torch_npu.testing._testcase.is_iterable",
    "torch_npu.testing._testcase.iter_indices",
    "torch_npu.testing._testcase.set_npu_device",
    "torch_npu.testing._testcase.strclass",
