...
class TestPublicBindings(TestCase):
    ...
    def test_modules_can_be_imported(self):
        ...
        private_allowlist = {
            ...
            "torch_npu.dynamo.torchair._ge_concrete_graph.ge_converter.experimental.hcom_send_recv",
            ...
            "torch_npu._inductor.ascend_npu_ir.ascend_npu_ir.npu.meta_compiler",
            ...
            "torch_npu._inductor.ascend_npu_ir.ascend_npu_ir.npu.codegen.meta_kernel",
        ...
        for mod, excep_type in failures:
            ...
            if mod.startswith("torch_npu.dynamo.torchair._inductor_npu_ext"):
                continue
