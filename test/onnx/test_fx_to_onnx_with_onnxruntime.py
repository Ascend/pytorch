...
class TestFxToOnnxWithOnnxRuntime(onnx_test_common._TestONNXRuntime):
    ...
    @pytorch_test_common.xfail(
        ...
        reason="pytorch/pytorch/issues/96379",
    )
    ...
    @pytorch_test_common.xfail(
        ...
        reason="pytorch/pytorch/issues/99534",
    )
    ...
    def test_log_sigmoid(self):
        ...
        self.run_test_with_fx_to_onnx_exporter_and_onnx_runtime(Model(), (input_,))
    ...
    def test_arange(self):
        class ArangeModel(torch.nn.Module):
            def forward(self, input_):
                return (
                    torch.arange(input_.shape[0]),
                    torch.arange(12),
                    torch.arange(start=input_.shape[0], end=input_.shape[0] + 5),
                )
    ...
    @pytorch_test_common.skipIfNoNPU
    def test__scaled_dot_product_flash_attention(self):
        ...
        x = torch.randn(1, 1, 1, 32, device=torch.device("npu"))
    ...
    def test_view_dynamic_zero_dim(self):
        class ViewModel(torch.nn.Module):
            def forward(self, input_):
                input_ = input_.view(-1, 2)
                return input_.view(1, -1)
    ...
    @pytorch_test_common.xfail_if_model_type_is_exportedprogram(
        ...
        reason="pytorch/pytorch/issues/112622",
    )
    ...
    @pytorch_test_common.xfail(
        ...
        reason="huggingface/transformers/issues/21013",
    )
...
class TestFxToOnnxFakeTensorWithOnnxRuntime(onnx_test_common._TestONNXRuntime):
    ...
    @pytorch_test_common.xfail_if_model_type_is_not_exportedprogram(
        ...
        reason="pytorch/pytorch/issues/115745",
    )
