...
class TestJitProfiler(JitTestCase):
    ...
    github.com/pytorch/pytorch/issues/91483 in which test_profiler was flaky and failed in the
...
graph(%Ra, %Rb):
  return (%Ra)""", graph)
    ...
    @unittest.skipIf(True, "TODO: re-enable with github.com/pytorch/pytorch/pull/29339")
...
dedent """
    ...
    @unittest.skip('pytorch/issues/9595')
