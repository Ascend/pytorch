...
void my_mm_dtype_out(Tensor out, Tensor self, Tensor mat2, int32_t out_dtype)
{
    aoti_torch_npu_mm_dtype_out(out.get(), self.get(), mat2.get(), static_cast<int32_t>(out_dtype));
}
...
Tensor my_rand_like(Tensor self, int32_t* dtype, int32_t* layout, std::optional<Device> device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    int32_t device_val = 0;
    int32_t* device_ptr = nullptr;
    ...
    aoti_torch_npu_rand_like(self.get(), dtype, layout, device_ptr, device_index, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_rand_like_generator(Tensor self, std::optional<AtenGeneratorHandle> generator, int32_t* dtype, int32_t* layout, std::optional<Device> device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    AtenGeneratorHandle generator_handle = generator.value_or(nullptr);
    int32_t device_val = 0;
    ...
    aoti_torch_npu_rand_like_generator(self.get(), generator_handle ? &generator_handle : nullptr, dtype, layout, device_ptr, device_index, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randint_like(Tensor self, int64_t high, int32_t* dtype, int32_t* layout, std::optional<Device> device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    int32_t device_val = 0;
    int32_t* device_ptr = nullptr;
    ...
    aoti_torch_npu_randint_like(self.get(), high, dtype, layout, device_ptr, device_index, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randint_like_low_dtype(Tensor self, int64_t low, int64_t high, int32_t* dtype, int32_t* layout, std::optional<Device> device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    int32_t device_val = 0;
    int32_t* device_ptr = nullptr;
    ...
    aoti_torch_npu_randint_like_low_dtype(self.get(), low, high, dtype, layout, device_ptr, device_index, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randn_like(Tensor self, int32_t* dtype, int32_t* layout, std::optional<Device> device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    int32_t device_val = 0;
    int32_t* device_ptr = nullptr;
    ...
    aoti_torch_npu_randn_like(self.get(), dtype, layout, device_ptr, device_index, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randn_like_generator(Tensor self, std::optional<AtenGeneratorHandle> generator, int32_t* dtype, int32_t* layout, std::optional<Device> device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    AtenGeneratorHandle generator_handle = generator.value_or(nullptr);
    int32_t device_val = 0;
    ...
    aoti_torch_npu_randn_like_generator(self.get(), generator_handle ? &generator_handle : nullptr, dtype, layout, device_ptr, device_index, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my__grouped_mm(Tensor self, Tensor mat2, std::optional<Tensor> offs, std::optional<Tensor> bias, int32_t* out_dtype)
{
    AtenTensorHandle ret0;
    if (offs.has_value() && bias.has_value()) {
        AtenTensorHandle offs_handle = offs.value().get();
        AtenTensorHandle bias_handle = bias.value().get();
        aoti_torch_npu__grouped_mm(self.get(), mat2.get(), &offs_handle, &bias_handle, out_dtype, &ret0);
    } else if (offs.has_value()) {
        AtenTensorHandle offs_handle = offs.value().get();
        aoti_torch_npu__grouped_mm(self.get(), mat2.get(), &offs_handle, nullptr, out_dtype, &ret0);
    } else if (bias.has_value()) {
        AtenTensorHandle bias_handle = bias.value().get();
        aoti_torch_npu__grouped_mm(self.get(), mat2.get(), nullptr, &bias_handle, out_dtype, &ret0);
    } else {
        aoti_torch_npu__grouped_mm(self.get(), mat2.get(), nullptr, nullptr, out_dtype, &ret0);
    }
    return Tensor(ret0);
}
...
STABLE_TORCH_LIBRARY_FRAGMENT(libtorch_agn_211, m) {
  ...
  m.def("my_mm_dtype_out(Tensor out, Tensor self, Tensor mat2, int out_dtype) -> ()");
  ...
  m.def("my_rand_like(Tensor self, ScalarType? dtype, Layout? layout, Device? device, bool? pin_memory, MemoryFormat? memory_format) -> Tensor");
  m.def("my_rand_like_generator(Tensor self, Generator? generator, ScalarType? dtype, Layout? layout, Device? device, bool? pin_memory, MemoryFormat? memory_format) -> Tensor");
  m.def("my_randint_like(Tensor self, int high, ScalarType? dtype, Layout? layout, Device? device, bool? pin_memory, MemoryFormat? memory_format) -> Tensor");
  m.def("my_randint_like_low_dtype(Tensor self, int low, int high, ScalarType? dtype, Layout? layout, Device? device, bool? pin_memory, MemoryFormat? memory_format) -> Tensor");
  m.def("my_randn_like(Tensor self, ScalarType? dtype, Layout? layout, Device? device, bool? pin_memory, MemoryFormat? memory_format) -> Tensor");
  m.def("my_randn_like_generator(Tensor self, Generator? generator, ScalarType? dtype, Layout? layout, Device? device, bool? pin_memory, MemoryFormat? memory_format) -> Tensor");
  m.def("my__grouped_mm(Tensor self, Tensor mat2, Tensor? offs, Tensor? bias, ScalarType? out_dtype) -> Tensor");
...
STABLE_TORCH_LIBRARY_IMPL(libtorch_agn_211, CompositeExplicitAutograd, m) {
    ...
    m.impl("my_mm_dtype_out", TORCH_BOX(&my_mm_dtype_out));
    ...
    m.impl("my_rand_like", TORCH_BOX(&my_rand_like));
    m.impl("my_rand_like_generator", TORCH_BOX(&my_rand_like_generator));
    m.impl("my_randint_like", TORCH_BOX(&my_randint_like));
    m.impl("my_randint_like_low_dtype", TORCH_BOX(&my_randint_like_low_dtype));
    m.impl("my_randn_like", TORCH_BOX(&my_randn_like));
    m.impl("my_randn_like_generator", TORCH_BOX(&my_randn_like_generator));
    m.impl("my__grouped_mm", TORCH_BOX(&my__grouped_mm));
