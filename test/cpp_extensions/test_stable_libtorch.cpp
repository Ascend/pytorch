...
Tensor my_rand_like(Tensor self, int32_t* dtype, int32_t* layout, int32_t* device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    aoti_torch_npu_rand_like(self.get(), dtype, layout, device, 0, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_rand_like_generator(Tensor self, std::optional<AtenGeneratorHandle> generator, int32_t* dtype, int32_t* layout, int32_t* device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    AtenGeneratorHandle generator_handle = generator.value_or(nullptr);
    aoti_torch_npu_rand_like_generator(self.get(), generator_handle ? &generator_handle : nullptr, dtype, layout, device, 0, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randint_like(Tensor self, int64_t high, int32_t* dtype, int32_t* layout, int32_t* device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    aoti_torch_npu_randint_like(self.get(), high, dtype, layout, device, 0, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randint_like_low_dtype(Tensor self, int64_t low, int64_t high, int32_t* dtype, int32_t* layout, int32_t* device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    aoti_torch_npu_randint_like_low_dtype(self.get(), low, high, dtype, layout, device, 0, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randn_like(Tensor self, int32_t* dtype, int32_t* layout, int32_t* device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    aoti_torch_npu_randn_like(self.get(), dtype, layout, device, 0, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}

Tensor my_randn_like_generator(Tensor self, std::optional<AtenGeneratorHandle> generator, int32_t* dtype, int32_t* layout, int32_t* device, int32_t* pin_memory, int32_t* memory_format)
{
    AtenTensorHandle ret0;
    AtenGeneratorHandle generator_handle = generator.value_or(nullptr);
    aoti_torch_npu_randn_like_generator(self.get(), generator_handle ? &generator_handle : nullptr, dtype, layout, device, 0, pin_memory, memory_format, &ret0);
    return Tensor(ret0);
}
