...
class TestFX(JitTestCase):
    ...
    def test_fx_shifts(self):
        ...
        input1 = torch.LongTensor(10).random_(0, 1024)

        m = MyModule()
        self.checkGraphModule(m, (input1,))
    ...
    def test_wrap_with_submodule(self):
        ...
        self.assertEqual(ref_batchnorm1d(input1), m(input1))
    ...
    def test_pickle_torch_custom_ops(self):
        ...
        pickled = pickle.dumps(gm)
        loaded = pickle.loads(pickled)
        self.assertEqual(loaded(input1), gm(input1))
    ...
    def test_custom_proxy_type(self):
        class TensorPair:
            ...
            def add(self, other):
                le = self.left + other.left
                r = self.right + other.right
                return TensorPair(le, r)
    ...
    def test_graph_fns(self):
        ...
        input1 = torch.rand(3)
        r = gm(input1)
        ref = torch.sin(mod.linear(input1) + mod.bias)
    ...
    def test_pickle_nonetype_annotation(self):
        ...
        self.assertEqual(loaded(input1, offsets), traced(input1, offsets))
    ...
    def test_fx_create_arg(self):
        ...
        class HasCustomArgObjectWhenLeaf(torch.nn.Module):
            def forward(self, s: CustomArgObject):
    ...
    def test_trace_fn_constant(self):
        ...
        self.assertEqual(traced(input1), add_const(input1))
    ...
    def test_interpreter(self):
        ...
        self.assertEqual(interpreter.run(input1), gm(input1))
        self.assertEqual(interpreter.run(input1), m(input1))
    ...
    def test_interpreter_run_node_override(self):
        ...
        input1 = torch.randn(3, 4)
        RunNodeInterpreter(gm).run(input1)
        for node in gm.graph.nodes:
    ...
    def test_interpreter_onthefly_swap(self):
        ...
        input1 = torch.randn(3, 4)
        result = NegSigmSwapInterpreter(gm).run(input1)
        self.assertEqual(result, torch.neg(input1).sigmoid())
    ...
    def test_transformer_noop(self):
        ...
        input1 = torch.randn(3, 4)
        self.assertEqual(new_gm(input1), gm(input1))
    ...
    def test_transformer_op_swap(self):
        ...
        input1 = torch.randn(3, 4)
        self.assertEqual(transformed(input1), torch.neg(input1).sigmoid())
    ...
    def test_insertion_point(self):
        ...
        input1 = torch.randn(33, 44)
        self.assertEqual(gm(input1), torch.relu(torch.neg(input1)))
    ...
    def test_immutable_list_pytree_ops(self):
        ...
        s = immutable_list([3, [rand_tensor, 42]])

        flattened, spec = pytree.tree_flatten(s)
        assert flattened == [3, rand_tensor, 42]

        unflattened = pytree.tree_unflatten(flattened, spec)
        assert unflattened == s
    ...
    def test_copy_it(self):
        ...
        s = immutable_list([(3, 4), (5, 6)])

        self.assertEqual(d, deepcopy(d))
        self.assertEqual(s, deepcopy(s))
    ...
    def test_inline_graph(self):
        ...
        input1 = torch.rand(3, 4)
        self.assertEqual(combined_module(input1), input1.relu().neg())
    ...
    def test_namedtuple_return_qualname(self):
        ...
        input1 = torch.rand(3, 4)
        self.assertEqual(traced(input1), MyNamedTup(input1, input1))
    ...
    def test_torchbind_class_attribute_in_fx_tensor_arg(self):
        ...
        traced = symbolic_trace(m)
        input1 = torch.randn(3, 4)
        self.assertEqual(traced(input1), m(input1))
    ...
    def test_script_method_trace(self):
        ...
        input1 = torch.randn(3, 4)
        self.assertEqual(traced(input1), h(input1))
    ...
    def test_namedtuple_return_trace(self):
        ...
        traced = symbolic_trace(NamedTupReturn())
        input1 = torch.rand(3, 4)
        self.assertEqual(traced(input1), Pair(input1, input1))
    ...
    def test_ast_rewriter_wrap_with_submodule(self):
        ...
        input1 = torch.rand(3, 2)
        ref_batchnorm1d = torch.nn.BatchNorm1d(2, affine=False)
        self.assertEqual(ref_batchnorm1d(input1), traced(input1))
    ...
    @unittest.skipIf(IS_WINDOWS, "Python Windows bug? issue 45108")
...
class TestFXNPU(TestCase):
    ...
    def test_graph_module(self):
        class MySub(torch.nn.Module):
            def __init__(self):
                super().__init__()
                self.w = torch.nn.Parameter(torch.rand(4, 3).npu())
