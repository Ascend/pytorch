...
class TestMultiStreamPass(TestUtils):
    ...
    def test_single_stream_compile_case(self, mock_multi_stream):
        arg0_1 = torch.randn(128, 128, device="npu")
        arg1_1 = torch.randn(128, 64, device="npu")
        arg2_1 = torch.randn(64, 128, device="npu")
        arg3_1 = torch.randn(128, 128, device="npu")
        arg4_1 = torch.randn(128, 128, device="npu")
        arg5_1 = torch.randn(128, 128, device="npu")
