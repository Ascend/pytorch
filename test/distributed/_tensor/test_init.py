...
class DTensorConstructorTest(DTensorTestBase):
    ...
    def test_zeros_full_mesh(self):
        ...
        # construct a npu device mesh with 2d: shard, replicate
        ...
        # construct a npu device mesh with 2d: shard, shard
    ...
    def test_zeros_submesh(self):
        ...
        # construct a npu device 1d mesh, with no sub pg initialized
        sub_mesh_list = [0, 3]
        ...
        # construct a npu device 1d mesh: unevenly, with subpg initialized
        sub_mesh_list = [0, 1, 3]
        ...
        # construct a npu device 2d mesh, with no subpg initialized
        sub_mesh_list = [[0], [3]]
        mesh = DeviceMesh(self.device_type, sub_mesh_list, _init_process_groups=False)
        placements = [Shard(0), Shard(1)]
        size = [32, 3]
