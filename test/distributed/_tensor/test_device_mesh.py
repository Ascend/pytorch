...
class TestDeviceMeshGetItem(DTensorTestBase):
    ...
    def test_get_item(self):
        ...
        self.assertEqual(tp_mesh.mesh, pg_ranks_by_dim_name.get("TP")[tp_group_idx])
    ...
    def test_get_parent_mesh(self):
        ...
        self.assertEqual(_mesh_resources.get_parent_mesh(two_d_mesh["DP"]), two_d_mesh)
        self.assertEqual(_mesh_resources.get_parent_mesh(two_d_mesh["TP"]), two_d_mesh)
...
class DeviceMeshCollectiveTest(DTensorTestBase):
    ...
    def test_scatter_1d(self):
        ...
        for scatter_dim, _ in enumerate(scatter_tensor_shape):
