...
|torch.cuda.get_sync_debug_mode|torch_npu.npu.get_sync_debug_mode|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|torch.cuda.set_sync_debug_mode|torch_npu.npu.set_sync_debug_mode|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|torch.cuda.Event.ipc_handle|torch_npu.npu.Event.ipc_handle|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|torch.cuda.memory.empty_cache|torch_npu.npu.empty_cache|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.mem_get_info|torch_npu.npu.mem_get_info|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.memory_stats|torch_npu.npu.memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.memory_summary|torch_npu.npu.memory_summary|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.memory_allocated|torch_npu.npu.memory_allocated|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.max_memory_allocated|torch_npu.npu.max_memory_allocated|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.reset_max_memory_allocated|torch_npu.npu.reset_max_memory_allocated|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.memory_reserved|torch_npu.npu.memory_reserved|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.max_memory_reserved|torch_npu.npu.max_memory_reserved|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.set_per_process_memory_fraction|torch_npu.npu.set_per_process_memory_fraction|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.memory_cached|torch_npu.npu.memory_cached|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.max_memory_cached|torch_npu.npu.max_memory_cached|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.reset_max_memory_cached|torch_npu.npu.reset_max_memory_cached|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.reset_peak_memory_stats|torch_npu.npu.reset_peak_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.caching_allocator_alloc|torch_npu.npu.caching_allocator_alloc|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.caching_allocator_delete|torch_npu.npu.caching_allocator_delete|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.get_allocator_backend|torch_npu.npu.get_allocator_backend|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.CUDAPluggableAllocator|torch_npu.npu.NPUPluggableAllocator|是<br>暂不支持<term>Ascend 950DT</term>|该接口涉及高危操作，使用请参考《自定义API》中的“[torch_npu.npu.NPUPluggableAllocator](https://gitcode.com/Ascend/op-plugin/blob/26.1.0/docs/zh/custom_APIs/torch_npu-npu/torch-npu-npu-NPUPluggableAllocator.md)”章节。|
|torch.cuda.memory.change_current_allocator|torch_npu.npu.change_current_allocator|是<br>暂不支持<term>Ascend 950DT</term>|该接口涉及高危操作，使用请参考《自定义API》中的“[torch_npu.npu.change_current_allocator](https://gitcode.com/Ascend/op-plugin/blob/26.1.0/docs/zh/custom_APIs/torch_npu-npu/torch-npu-npu-change_current_allocator.md)”章节。|
...
|torch.cuda.memory.reset_accumulated_host_memory_stats| torch_npu.npu.reset_accumulated_host_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.reset_peak_host_memory_stats|torch_npu.npu.reset_peak_host_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.host_memory_stats_as_nested_dict|torch_npu.npu.host_memory_stats_as_nested_dict|是<br>暂不支持<term>Ascend 950DT</term>|-|
|torch.cuda.memory.host_memory_stats|torch_npu.npu.host_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
