...
|torch.nn.functional.selu|是|支持fp16，fp32<br>fp16的反向场景下对比GPU存在精度累加误差，可以通过如下方式进行规避：将正向调用的torch.nn.functional.selu替换成torch.ops.aten.elu，例如：将torch.nn.functional.selu(input_x)替换为torch.ops.aten.elu(input_x, 1.6732632423543772848170429916717, 1.0507009873554804934193349852946)|
...
|torch.nn.functional.interpolate|是|支持fp16，fp32<br>支持nearest，linear，bilinear，bicubic，trilinear，area<br>不支持scale_factor|
