...
|[torch.nn.GroupNorm](https://pytorch.org/docs/2.7/generated/torch.nn.GroupNorm.html)|是|支持fp32<br>eps参数需大于0<br>不支持jit_compile=True的场景<br>该API仅支持2维及以上的输入input。该API反向不支持输入input不为4维，或输入num_groups非32整除，或C轴维度非(10 * num_groups)整除的场景|
...
|[torch.nn.NLLLoss](https://pytorch.org/docs/2.7/generated/torch.nn.NLLLoss.html)|是|支持fp16，fp32<br>target每一维的维度应该大于等于0且小于input的类别数|
