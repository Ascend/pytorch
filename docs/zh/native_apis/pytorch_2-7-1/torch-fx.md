...
**原生文档**：[torch.fx.GraphModule.__init__](https://pytorch.org/docs/2.7/fx.html#torch.fx.GraphModule.__init__)
...
**原生文档**：[torch.fx.Graph.__init__](https://pytorch.org/docs/2.7/fx.html#torch.fx.Graph.__init__)
