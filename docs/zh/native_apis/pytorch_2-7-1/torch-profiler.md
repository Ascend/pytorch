...
|torch.profiler._KinetoProfile.add_metadata|torch_npu.profiler._KinetoProfile.add_metadata|是|-|
|torch.profiler._KinetoProfile.add_metadata_json|torch_npu.profiler._KinetoProfile.add_metadata_json|是|-|
|torch.profiler._KinetoProfile.events|-|否|-|
|torch.profiler._KinetoProfile.export_chrome_trace|torch_npu.profiler._KinetoProfile.export_chrome_trace|是|-|
|torch.profiler._KinetoProfile.export_memory_timeline|torch_npu.profiler._KinetoProfile.export_memory_timeline|是|-|
|torch.profiler._KinetoProfile.export_stacks|torch_npu.profiler._KinetoProfile.export_stacks|是|-|
