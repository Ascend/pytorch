...
|[torch.cuda.get_sync_debug_mode](https://pytorch.org/docs/2.12/generated/torch.cuda.get_sync_debug_mode.html)|torch_npu.npu.get_sync_debug_mode|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|[torch.cuda.set_sync_debug_mode](https://pytorch.org/docs/2.12/generated/torch.cuda.set_sync_debug_mode.html)|torch_npu.npu.set_sync_debug_mode|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|[torch.cuda.Event.elapsed_time](https://pytorch.org/docs/2.12/generated/torch.cuda.Event.html#torch.cuda.Event.elapsed_time)|torch_npu.npu.Event.elapsed_time|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.Event.from_ipc_handle](https://pytorch.org/docs/2.12/generated/torch.cuda.Event.html#torch.cuda.Event.from_ipc_handle)|torch_npu.npu.Event.from_ipc_handle|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.Event.ipc_handle](https://pytorch.org/docs/2.12/generated/torch.cuda.Event.html#torch.cuda.Event.ipc_handle)|torch_npu.npu.Event.ipc_handle|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|[torch.cuda.memory_summary](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.memory_summary.html)|torch_npu.npu.memory_summary|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|[torch.cuda.set_per_process_memory_fraction](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.set_per_process_memory_fraction.html)|torch_npu.npu.set_per_process_memory_fraction|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|[torch.cuda.caching_allocator_alloc](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.caching_allocator_alloc.html)|torch_npu.npu.caching_allocator_alloc|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.caching_allocator_delete](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.caching_allocator_delete.html)|torch_npu.npu.caching_allocator_delete|是<br>暂不支持<term>Ascend 950DT</term>|-|
...
|[torch.cuda._sanitizer.enable_cuda_sanitizer](https://pytorch.org/docs/2.12/cuda._sanitizer.html#torch.cuda._sanitizer.enable_cuda_sanitizer)|torch_npu.npu._sanitizer.enable_npu_sanitizer|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.reset_accumulated_host_memory_stats](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.reset_accumulated_host_memory_stats.html)|torch_npu.npu.reset_accumulated_host_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.reset_peak_host_memory_stats](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.reset_peak_host_memory_stats.html)| torch_npu.npu.reset_peak_host_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.host_memory_stats_as_nested_dict](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.host_memory_stats_as_nested_dict.html)|torch_npu.npu.host_memory_stats_as_nested_dict|是<br>暂不支持<term>Ascend 950DT</term>|-|
|[torch.cuda.host_memory_stats](https://pytorch.org/docs/2.12/generated/torch.cuda.memory.host_memory_stats.html)|torch_npu.npu.host_memory_stats|是<br>暂不支持<term>Ascend 950DT</term>|-|
