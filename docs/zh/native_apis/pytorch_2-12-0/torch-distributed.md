...
**原生文档**：[torch.distributed.PrefixStore.__init__](https://pytorch.org/docs/2.12/distributed.html#torch.distributed.PrefixStore.__init__)
...
**原生文档**：[torch.distributed.Store.__init__](https://pytorch.org/docs/2.12/distributed.html#torch.distributed.Store.__init__)
...
**原生文档**：[torch.distributed.TCPStore.__init__](https://pytorch.org/docs/2.12/distributed.html#torch.distributed.TCPStore.__init__)
...
**原生文档**：[torch.distributed.HashStore.__init__](https://pytorch.org/docs/2.12/distributed.html#torch.distributed.HashStore.__init__)
...
**原生文档**：[torch.distributed.FileStore.__init__](https://pytorch.org/docs/2.12/distributed.html#torch.distributed.FileStore.__init__)
