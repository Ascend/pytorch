...
介绍PyTorch2.12.0版本原生API在昇腾NPU上的支持情况与限制说明，具体使用方法请参考考[PyTorch社区文档](https://pytorch.org/docs/2.12/)。原生API的支持情况可划分为如下四类：
...
- **未验证**：部分API虽在[PyTorch社区文档](https://pytorch.org/docs/2.12/)中存在，但未收录于本支持清单。这类API尚未验证，请谨慎使用。我们将持续进行验证工作，并在验证完成后更新文档。
