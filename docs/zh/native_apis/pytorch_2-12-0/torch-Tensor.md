...
|Tensor.add|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.addmm|是<br>暂不支持<term>Ascend 950DT</term>|支持fp16，fp32|
...
|Tensor.argmin|是|支持fp16，fp32，uint8，int8，int16，int32，int64|
...
|Tensor.all|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
|Tensor.any|是|支持fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.clamp|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64|
...
|Tensor.cumsum|是|支持fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128<br>支持Named Tensor|
...
|Tensor.div|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.eq|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
...
|Tensor.exp|是|支持bf16，fp16，fp32，int64，bool，complex64，complex128|
...
|Tensor.gather|是|支持fp16，fp32，int64<br>index维度需与input维度一致<br>针对<term>Ascend 950DT</term>，由于硬件差异，在索引存在重复的情况下，精度可能和<term>Atlas A2 训练系列产品</term>/<term>Atlas A3 训练系列产品</term>存在差异|
|Tensor.ge|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.get_device|是|-|
|Tensor.gt|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.index_add|是|支持fp16，fp32，uint8，int8，int16，int32，int64|
...
|Tensor.index_fill|是|支持fp16，fp32，int32，bool|
...
|Tensor.index_put|是|支持int64<br>针对<term>Ascend 950DT</term>，由于硬件差异，在索引存在重复的情况下，精度可能和<term>Atlas A2 训练系列产品</term>/<term>Atlas A3 训练系列产品</term>存在差异|
|Tensor.index_reduce_|是|可能回退至CPU执行|
|Tensor.index_reduce|是|可能回退至CPU执行|
|Tensor.index_select|是|支持fp16，fp32，int16，int32，int64，bool|
...
|Tensor.le|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.log|是|支持bf16，fp16，fp32，int64，bool，complex64，complex128|
...
|Tensor.logical_and_|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
|Tensor.logical_not|是|支持fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.lt|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.masked_fill|是|支持fp16，fp32，int64，bool|
|Tensor.masked_select|是|支持fp32，bool|
...
|Tensor.maximum|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
|Tensor.mean|是|支持bf16，fp16，fp32，complex64，complex128|
...
|Tensor.minimum|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
|Tensor.mm|是<br>暂不支持<term>Ascend 950DT</term>|支持fp16，fp32|
|Tensor.smm|否|-|
|Tensor.mode|否|-|
...
|Tensor.mul|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
...
|Tensor.ne|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
...
|Tensor.neg|是|支持fp16，fp32，int8，int32，int64，complex64，complex128|
...
|Tensor.nonzero|是<br>暂不支持<term>Ascend 950DT</term>|支持fp16，fp32，uint8，int8，int16，int32，int64，bool<br>不支持nan场景|
...
|Tensor.pow|是|支持bf16，fp16，fp32，fp64，int16，int64|
...
|Tensor.reciprocal|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
...
|Tensor.remainder|是|支持fp16，fp32，int32，int64|
|Tensor.remainder_|是<br>暂不支持<term>Ascend 950DT</term>|支持fp16，fp32，int32，int64|
|Tensor.repeat|是|支持fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
|Tensor.repeat_interleave|是|支持fp16，fp32，int16，int32，bool<br>输入张量在重复后得到输出，输出中元素个数需小于$2^{22}$|
...
|Tensor.roll|是|支持fp16，fp32，int32，int64，bool|
...
|Tensor.rsqrt|是|支持fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
|Tensor.rsqrt_|是|支持fp16，fp32，complex64，complex128|
|Tensor.scatter|是|支持fp16，fp32，int16，int32，bool<br>针对<term>Ascend 950DT</term>，由于硬件差异，在索引存在重复的情况下，精度可能和<term>Atlas A2 训练系列产品</term>/<term>Atlas A3 训练系列产品</term>存在差异|
...
|Tensor.scatter_add|是|支持fp32<br>针对<term>Ascend 950DT</term>，由于硬件差异，在索引存在重复的情况下，精度可能和<term>Atlas A2 训练系列产品</term>/<term>Atlas A3 训练系列产品</term>存在差异|
...
|Tensor.sign|是<br>暂不支持<term>Ascend 950DT</term>|支持bf16，fp16，fp32，int32，int64，bool|
...
|Tensor.sin|是<br>暂不支持<term>Ascend 950DT</term>|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool，complex64，complex128|
...
|Tensor.sort|是|支持fp16，fp32，uint8，int8，int16，int32，int64<br>针对<term>Ascend 950DT</term>，由于底层实现限制，"stable"仅支持True，设置为False在执行时会自动修改为True|
...
|Tensor.sqrt|是|支持fp16，fp32，fp64，uint8，int8，int16，int32，int64，bool|
...
|Tensor.sum|是|支持bf16，fp16，fp32，int32|
...
|Tensor.tril|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
|Tensor.tril_|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
|Tensor.triu|是|支持bf16，fp16，fp32，uint8，int8，int16，int32，int64，bool|
...
|Tensor.where|是|支持bf16，fp16，fp32，fp64，uint8，int8，int16，int32，int64，bool，complex64，complex128|
