...
**原生文档**：[torch.monitor.Stat.__init__](https://pytorch.org/docs/2.11/monitor.html#torch.monitor.Stat.__init__)
...
**原生文档**：[torch.monitor.Event.__init__](https://pytorch.org/docs/2.11/monitor.html#torch.monitor.Event.__init__)
...
**原生文档**：[torch.monitor.TensorboardEventHandler.__init__](https://pytorch.org/docs/2.11/monitor.html#torch.monitor.TensorboardEventHandler.__init__)
