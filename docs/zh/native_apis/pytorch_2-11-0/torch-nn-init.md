...
|API名称|是否支持|限制与说明|
|--|--|--|
|[torch.nn.init.calculate_gain](https://pytorch.org/docs/2.11/nn.init.html#torch.nn.init.calculate_gain)|是|-|
|[torch.nn.init.uniform_](https://pytorch.org/docs/2.11/nn.init.html#torch.nn.init.uniform_)|是|支持fp32|
|[torch.nn.init.normal_](https://pytorch.org/docs/2.11/nn.init.html#torch.nn.init.normal_)|是|支持fp32|
|[torch.nn.init.constant_](https://pytorch.org/docs/2.11/nn.init.html#torch.nn.init.constant_)|是|支持fp32|
