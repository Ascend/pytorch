...
参考《CANN 故障处理》中的“进程中断问题定位思路”章节进行故障处理。
<!-- [进程中断问题定位思路](https://www.hiascend.com/document/detail/zh/canncommercial/900/maintenref/troubleshooting/troubleshooting_0062.html) -->
