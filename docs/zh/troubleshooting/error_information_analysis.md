...
1.  查看回显信息中的首报错。
    ...
    "EZ3002"即为CANN软件错误码，用户可以参考《CANN 故障处理》的“[错误码参考](https://www.hiascend.com/document/detail/zh/canncommercial/83RC1/maintenref/troubleshooting/troubleshooting_0225.html)”章节，根据对应错误码信息进行故障分析，如仍不明确问题来源，可进一步查看其他回显信息。
