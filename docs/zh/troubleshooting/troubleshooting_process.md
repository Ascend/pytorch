...
- 参考“错误码”处理
    ...
    关于CANN软件“错误码”的详细介绍，请参见《CANN 故障处理》的“错误码参考”章节。
...
- 收集故障信息
    ...
    关于日志级别的详细介绍，请参见《CANN 日志参考》中的“设置日志级别”章节。
    <!-- [设置日志级别](https://www.hiascend.com/document/detail/zh/canncommercial/900/maintenref/logreference/logreference_0008.html) -->

    关于日志路径以及日志文件的详细介绍，请参见《CANN 日志参考》中的“查看日志（Ascend EP）”章节。
    <!-- [查看日志（Ascend EP）](https://www.hiascend.com/document/detail/zh/canncommercial/900/maintenref/logreference/logreference_0002.html) -->
