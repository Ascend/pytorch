...
> -   acl.rt.set\_op\_wait\_timeout接口详情具体请参见《CANN   应用开发接口》中“函数：set\_op\_wait\_timeout”章节。
> -   acl.rt.stream\_wait\_event接口详情具体请参见《CANN   应用开发接口》中“函数：stream\_wait\_event”章节。
