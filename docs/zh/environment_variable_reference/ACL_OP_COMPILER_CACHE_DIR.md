...
- 如果设置了ACL\_OP\_DEBUG\_LEVEL编译选项，则只有编译选项值为0或3才会启用编译缓存功能，其它取值禁用编译缓存功能。ACL\_OP\_DEBUG\_LEVEL编译选项具体可参考《CANN 应用开发接口》的“[aclCompileOpt](https://www.hiascend.com/document/detail/zh/canncommercial/900/API/ascendgraphapi/aclcppdevg_03_1371.html)”章节。
