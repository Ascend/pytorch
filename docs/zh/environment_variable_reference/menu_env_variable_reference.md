...
- [算子执行](op_execution.md)
  ...
  - [TORCH\_NPU\_LEGACY\_IMPL\_LIST](TORCH_NPU_LEGACY_IMPL_LIST.md)
  - [TORCH\_ACL\_INIT\_CONFIG\_PATH](TORCH_ACL_INIT_CONFIG_PATH.md)
...
- [集合通信](collective_communication.md)
  ...
  - [TORCH\_HCCL\_ASYNC\_ERROR\_HANDLING](TORCH_HCCL_ASYNC_ERROR_HANDLING.md)
  - [TORCH\_HCCL\_DESYNC\_DEBUG](TORCH_HCCL_DESYNC_DEBUG.md)
