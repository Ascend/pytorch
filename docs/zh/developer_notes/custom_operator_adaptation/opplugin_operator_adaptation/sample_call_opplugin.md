...
1. 安装PyTorch和TorchNPU，具体请参见[源码编译](../../../installation_guide/building_from_source.md)。
...
1. 编译TorchNPU插件并安装，推荐使用容器场景进行编译，具体操作可参考[源码安装](../../../installation_guide/building_from_source.md)章节的“方式一（推荐）：容器场景”。
