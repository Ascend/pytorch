...
>
> <!-- npu="950" id1 -->
> <term>Ascend 950DT系列产品</term>暂不支持Python编译优化。
> <!-- end id1 -->
...
3. 编译安装。<a id="li2673165610272"></a>
    - 毕昇环境变量配置详见[安装毕昇编译器](install_bisheng_compiler.md)，另外需设置如下环境变量：
...
4. 配置使用。<a id="li10673155619274"></a>
    - 安装目录里使用./bin/python3即可打开安装好的Python可执行文件，并进入Python命令行。
