...
-   如果您想体验大模型训练更丰富的功能，请参见[表1](#模型迁移指导)阅读了解。
    ...
    **表 1**  模型迁移指导<a id="模型迁移指导"></a>    
    ...
    |Megatron-LM大语言模型|MindSpeed LLM套件|请参见《[MindSpeed LLM迁移指南（PyTorch框架）](https://gitcode.com/Ascend/MindSpeed-LLM/wiki/MindSpeed-LLM%E8%BF%81%E7%A7%BB%E6%8C%87%E5%8D%97-Pytorch%E6%A1%86%E6%9E%B6.md)》。|
