...
TorchNPU算子操作基础接口可参见[LINK](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/torch_npu/csrc/framework/utils/OpPreparation.h)。常见接口如下：
...
算子适配宏定义接口可参见[LINK](https://gitcode.com/Ascend/op-plugin/blob/26.1.0/op_plugin/utils/op_api_common.h)。常见宏定义如下：
