...
3. 在框架算子适配前，请先确保CANN已有相关算子实现，具体可查询[CANN 算子库接口](https://www.hiascend.com/document/detail/zh/canncommercial/900/API/aolapi/operatorlist_00001.html)。
    > [!NOTE]
    >
    > 本示例对应CANN算子为aclnnAdd，可参考[CANN 算子库接口]中[NN算子接口](https://www.hiascend.com/document/detail/zh/canncommercial/900/API/aolapi/context/ops-math/aclnnAdd&aclnnInplaceAdd.md)。
