...
> [!NOTICE]
>
> - 使用Inductor后端前，请先安装v3.2.1版本的Triton Ascend。该版本仅支持PyTorch 2.7.1和2.9.0。具体信息请参考[Triton Ascend](https://github.com/triton-lang/triton-ascend/blob/release/3.2.1/README_zh.md)。
