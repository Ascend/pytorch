...
通过此环境变量可精简打印错误信息，开启后会将CANN内部调用栈、TorchNPU错误码等自定义报错信息转移到plog中，仅保留有效的错误说明，提高异常信息的可读性。plog的详细信息请参考[plog日志信息](../../../user_guide/troubleshooting/error_information_analysis_guide/error_information_classification/plog_log.md)。
