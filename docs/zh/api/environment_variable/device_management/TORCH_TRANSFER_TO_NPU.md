...
- 更多transfer\_to\_npu相关约束参考[（推荐）自动迁移](https://www.hiascend.com/document/detail/zh/ModelZoo/traditional_model_train/PyTorch/docs/zh/model_migration/auto_migration.md)。
