...
**原生文档**：[torch.distributed.all_gather_into_tensor](https://pytorch.org/docs/2.13/distributed.html#torch.distributed.all_gather_into_tensor)
...
**原生文档**：[torch.distributed.reduce_scatter_tensor](https://pytorch.org/docs/2.13/distributed.html#torch.distributed.reduce_scatter_tensor)
