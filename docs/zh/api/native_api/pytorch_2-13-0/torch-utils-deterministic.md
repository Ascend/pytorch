...
> - 目录下罗列的模块和原生文档一致，对于模块的相关说明请查看原生文档[LINK](https://pytorch.org/docs/2.13/deterministic.html)。
...
**原生文档**：[torch.utils.deterministic.fill_uninitialized_memory](https://pytorch.org/docs/2.13/deterministic.html#torch.utils.deterministic.fill_uninitialized_memory)
