...
**原生文档**：[torch.utils.data.IterDataPipe](https://pytorch.org/docs/2.9/data.html#torch.utils.data.IterDataPipe)
...
**原生文档**：[torch.utils.data.MapDataPipe](https://pytorch.org/docs/2.9/data.html#torch.utils.data.MapDataPipe)
...
**原生文档**：[torch.utils.data.graph_settings.apply_sharding](https://pytorch.org/docs/2.9/data.html#torch.utils.data.graph_settings.apply_sharding)
...
**原生文档**：[torch.utils.data.graph_settings.get_all_graph_pipes](https://pytorch.org/docs/2.9/data.html#torch.utils.data.graph_settings.get_all_graph_pipes)
