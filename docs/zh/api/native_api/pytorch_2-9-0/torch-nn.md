...
> - 目录下罗列的模块和原生文档一致，对于模块的相关说明请查看原生文档[LINK](https://pytorch.org/docs/2.9/nn.html)。
...
**原生文档**：[torch.nn.Flatten](https://docs.pytorch.org/docs/2.9/generated/torch.nn.modules.flatten.Flatten.html#torch.nn.modules.flatten.Flatten)
...
**原生文档**：[torch.nn.Unflatten](https://docs.pytorch.org/docs/2.9/generated/torch.nn.modules.flatten.Unflatten.html#torch.nn.modules.flatten.Unflatten)
...
**原生文档**：[torch.nn.Unflatten.NamedShape](https://docs.pytorch.org/docs/2.9/generated/torch.nn.modules.flatten.Unflatten.html#torch.nn.modules.flatten.Unflatten.NamedShape)
