...
**原生文档**：[torch.profiler._KinetoProfile](https://pytorch.org/docs/2.11/profiler.html#torch.profiler._KinetoProfile)
...
**原生文档**：[torch.profiler._KinetoProfile.add_metadata](https://pytorch.org/docs/2.11/profiler.html#torch.profiler._KinetoProfile.add_metadata)
...
**原生文档**：[torch.profiler._KinetoProfile.add_metadata_json](https://pytorch.org/docs/2.11/profiler.html#torch.profiler._KinetoProfile.add_metadata_json)
...
**原生文档**：[torch.profiler._KinetoProfile.export_chrome_trace](https://pytorch.org/docs/2.11/profiler.html#torch.profiler._KinetoProfile.export_chrome_trace)
...
**原生文档**：[torch.profiler._KinetoProfile.export_memory_timeline](https://pytorch.org/docs/2.11/profiler.html#torch.profiler._KinetoProfile.export_memory_timeline)
...
**原生文档**：[torch.profiler._KinetoProfile.export_stacks](https://pytorch.org/docs/2.11/profiler.html#torch.profiler._KinetoProfile.export_stacks)
...
**原生文档**：[torch.profiler.profile](https://pytorch.org/docs/2.11/profiler.html#torch.profiler.profile)
...
**原生文档**：[torch.profiler.profile.step](https://pytorch.org/docs/2.11/profiler.html#torch.profiler.profile.step)
...
**原生文档**：[torch.profiler.ProfilerAction](https://pytorch.org/docs/2.11/profiler.html#torch.profiler.ProfilerAction)
...
**原生文档**：[torch.profiler.ProfilerActivity](https://pytorch.org/docs/2.11/profiler.html#torch.profiler.ProfilerActivity)
...
**原生文档**：[torch.profiler.schedule](https://pytorch.org/docs/2.11/profiler.html#torch.profiler.schedule)
...
**原生文档**：[torch.profiler.tensorboard_trace_handler](https://pytorch.org/docs/2.11/profiler.html#torch.profiler.tensorboard_trace_handler)
