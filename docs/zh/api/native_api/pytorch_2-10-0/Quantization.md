...
> - 注：在[Quantization Accuracy Debugging](https://docs.pytorch.org/docs/2.10/quantization.html)中可以找到[Numerical Debugging Tooling](#numerical-debugging-tooling)下API的具体用法。
...
**原生文档**：[torch.ao.ns.fx.utils.compute_sqnr](https://docs.pytorch.org/docs/2.10/quantization.html#torch.ao.ns.fx.utils.compute_sqnr)
