...
**原生文档**：[torch.utils.benchmark.Timer.adaptive_autorange](https://pytorch.org/docs/2.7/benchmark_utils.html#torch.utils.benchmark.Timer.adaptive_autorange)
...
**原生文档**：[torch.utils.benchmark.Compare](https://pytorch.org/docs/2.7/benchmark_utils.html#torch.utils.benchmark.Compare)
...
**原生文档**：[torch.utils.benchmark.Compare.colorize](https://pytorch.org/docs/2.7/benchmark_utils.html#torch.utils.benchmark.Compare.colorize)
...
**原生文档**：[torch.utils.benchmark.Compare.trim_significant_figures](https://pytorch.org/docs/2.7/benchmark_utils.html#torch.utils.benchmark.Compare.trim_significant_figures)
