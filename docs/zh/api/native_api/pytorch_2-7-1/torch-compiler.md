...
> - 目录下罗列的模块和原生文档一致，对于模块的相关说明请查看原生文档[LINK](https://docs.pytorch.org/docs/2.7/torch.compiler_api.html)。
...
**原生文档**：[torch.compiler.set_stance](https://pytorch.org/docs/2.7/generated/torch.compiler.set_stance.html)
...
**原生文档**：[torch.compiler.is_exporting](https://pytorch.org/docs/2.7/generated/torch.compiler.is_exporting.html)
