...
> - 目录下罗列的模块和原生文档一致，对于模块的相关说明请查看原生文档[LINK](https://pytorch.org/docs/2.12/benchmark_utils.html)。
...
**原生文档**：[torch.utils.benchmark.Timer.adaptive_autorange](https://pytorch.org/docs/2.12/benchmark_utils.html#torch.utils.benchmark.Timer.adaptive_autorange)
...
**原生文档**：[torch.utils.benchmark.Compare](https://pytorch.org/docs/2.12/benchmark_utils.html#torch.utils.benchmark.Compare)
...
**原生文档**：[torch.utils.benchmark.Compare.colorize](https://pytorch.org/docs/2.12/benchmark_utils.html#torch.utils.benchmark.Compare.colorize)
...
**原生文档**：[torch.utils.benchmark.Compare.trim_significant_figures](https://pytorch.org/docs/2.12/benchmark_utils.html#torch.utils.benchmark.Compare.trim_significant_figures)
