...
> - 目录下罗列的模块和原生文档一致，对于模块的相关说明请查看原生文档[LINK](https://pytorch.org/docs/2.12/fx.html)。
...
**原生文档**：[torch.fx.Interpreter.boxed_run](https://pytorch.org/docs/2.12/fx.html#torch.fx.Interpreter.boxed_run)
