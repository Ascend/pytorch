...
> - 目录下罗列的模块和原生文档一致，对于模块的相关说明请查看原生文档[LINK](https://pytorch.org/docs/2.12/tensorboard.html)。
...
**原生文档**：[torch.utils.tensorboard.writer.SummaryWriter.\_\_init\_\_](https://pytorch.org/docs/2.12/tensorboard.html#torch.utils.tensorboard.writer.SummaryWriter.__init__)
