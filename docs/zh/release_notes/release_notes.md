...
|--|--|--|--|--|--|
|商用版：9.0.0<br>社区版：9.0.0|2.7.1|26.0.0|v2.7.1-26.0.0|2.7.1.post2|Python3.9.*x*、Python3.10.*x*、Python3.11.*x*、Python3.12.*x*、Python3.13.*x*|
|商用版：9.0.0<br>社区版：9.0.0|2.8.0|26.0.0|v2.8.0-26.0.0|2.8.0.post2|Python3.9.*x*、Python3.10.*x*、Python3.11.*x*、Python3.12.*x*、Python3.13.*x*|
|商用版：9.0.0<br>社区版：9.0.0|2.9.0|26.0.0|v2.9.0-26.0.0|2.9.0|Python3.10.*x*、Python3.11.*x*、Python3.12.*x*、Python3.13.*x*|
|商用版：9.0.0<br>社区版：9.0.0|2.10.0|26.0.0|v7.3.0-26.0.0|2.10.0|Python3.10.*x*、Python3.11.*x*、Python3.12.*x*、Python3.13.*x*|

**表 2**  组件间配套表

|Ascend Extension for PyTorch版本|Ascend Extension for PyTorch代码分支名称|Ascend Extension for PyTorch安装包版本|DrivingSDK|
|--|--|--|--|
|26.0.0|v2.7.1-26.0.0|2.7.1.post2|7.3.0|
|26.0.0|v2.8.0-26.0.0|2.8.0.post2|7.3.0|
|26.0.0|v2.9.0-26.0.0|2.9.0|7.3.0|
|26.0.0|v2.10.0-26.0.0|2.10.0|7.3.0|

## 版本兼容性说明

|Ascend Extension for PyTorch版本|CANN版本|网上相关产品版本兼容性|
|--|--|--|
|26.0.0|CANN 8.5.0<br>CANN 8.3.RC1<br>CANN 8.2.RC1<br>CANN 8.1.RC1<br>CANN 8.0.0|DrivingSDK 7.3.0兼容CANN 8.1.RC1、CANN 8.2.RC1、CANN 8.3.RC1、CANN 8.5.0|
...
**表 3** Ascend Extension for PyTorch接口变更汇总
...
<td class="cellrowborder" valign="top" width="85.53%" headers="mcps1.1.3.4.1 "><p id="p119831219181019">通过添加编译选项-Bsymbolic-functions控制优先查找库内符号，避免so间跨ABI调用导致的未知错误</p>
</td>
</tr>
