...
<!-- md-trans-meta sourceCommit=e6dd39e7131a89f72cf49d80d53002e4cc645bbf translatedAt=2026-07-09T08:39:36.485Z pushedAt=2026-07-09T08:44:08.370Z -->
...
|torch.set_default_tensor_type|Yes|Passing torch.npu.DtypeTensor type is not supported|
|torch.numel|Yes|-|
...
|torch.arange|Yes|Supports bf16, fp16, fp32, fp64, int32, int64|
|torch.range|Yes|-|
...
|torch.gather|Yes|Supports fp16, fp32, int16, int32, int64, bool<br>The number of dimensions of index must be consistent with the number of dimensions of input|
...
|torch.narrow_copy|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool<br>May Fall Back to CPU Execution|
|torch.nonzero|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64, bool|
...
|torch.scatter|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool, complex64, complex128<br>May Fall Back to CPU Execution|
...
|torch.tile|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool, complex64, complex128<br>If the length of the input parameter dims is less than the length of input.shape, ones will be automatically prepended to dims to align its length with input.shape. The padded dims must satisfy the following constraints:<br>- When repeating along the first axis, a maximum of 4 dimensions can be repeated simultaneously (i.e., the number of elements greater than 1 in dims ≤ 4). For example: torch.tile(input, [2, 3, 4, 5, 6]) is not supported, while torch.tile(input, [2, 3, 1, 5, 6]) is supported.<br>- When not repeating along the first axis, a maximum of 3 dimensions can be repeated simultaneously (i.e., the number of elements greater than 1 in dims ≤ 3). For example: torch.tile(input, [1, 3, 4, 5, 6]) is not supported, while torch.tile(input, [1, 3, 1, 5, 6]) is supported.<br>- If performing backward computation, the sum of the number of dimensions of the input Tensor and the number of elements greater than 1 in the input parameter dims must not exceed 8|
...
|torch.where|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool<br>8-dimensional shapes are not supported|
|torch.Generator|Yes|-|
...
|torch.normal|Yes|Supports fp16, fp32|
|torch.poisson|No|-|
|torch.rand|Yes|-|
...
|torch.acosh|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool, complex64, complex128<br>May Fall Back to CPU Execution|
...
|torch.addcdiv|Yes|Supports fp16, fp32, int64<br>Simultaneous broadcasting of three tensors is not supported under int64 type|
|torch.addcmul|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int32, int64<br>Simultaneous broadcasting of three tensors is not supported under fp64, uint8, int8, int64 types|
...
|torch.bitwise_not|Yes|Supports uint8, int8, int16, int32, int64, bool|
|torch.bitwise_and|Yes|Supports uint8, int8, int16, int32, int64, bool|
|torch.bitwise_or|Yes|Supports uint8, int8, int16, int32, int64, bool|
|torch.bitwise_xor|Yes|Supports uint8, int8, int16, int32, int64, bool|
|torch.bitwise_left_shift|Yes|Supports uint8, int8, int16, int32, int64|
|torch.ceil|Yes|Supports fp16, fp32|
|torch.clamp|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64|
|torch.clip|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64|
|torch.copysign|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool<br>May Fall Back to CPU Execution|
|torch.cos|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
...
|torch.div|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
...
|torch.exp|Yes|Supports bf16, fp16, fp32, fp64, int64, bool, complex64, complex128|
...
|torch.floor_divide|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64|
...
|torch.log|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.log10|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool, complex64, complex128<br>When input is uint8, int8, int16, int32, int64, or bool, output out must be fp32<br>For other supported data types, output out remains consistent with input|
...
|torch.logical_not|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64, bool|
...
|torch.logit|Yes|Supports bf16, fp16, fp32<br>When eps is greater than 1, output is nan; when eps is 1, output is inf|
|torch.mul|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
...
|torch.neg|Yes|Supports bf16, fp16, fp32, int8, int32, int64, complex64, complex128|
...
|torch.pow|Yes|Supports bf16, fp16, fp32, fp64, int16, int64|
...
|torch.reciprocal|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.remainder|Yes|Supports fp16, fp32, int16, int32, int64|
|torch.round|Yes|Supports bf16, fp16, fp32, fp64, int32, int64|
|torch.rsqrt|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.sigmoid|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.sign|Yes|Supports bf16, fp16, fp32, int32, int64, bool|
|torch.sgn|Yes|Supports bf16, fp16, fp32, int32, int64, bool, complex64, complex128|
|torch.sin|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.sinh|Yes|Supports fp16, fp32, fp64|
|torch.softmax|Yes|Supports fp32<br>Supports Named Tensor|
...
|torch.trunc|Yes|Supports fp16, fp32<br>May Fall Back to CPU Execution|
...
|torch.argmin|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64|
...
|torch.mean|Yes|Supports bf16, fp16, fp32, complex64, complex128|
|torch.median|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64|
|torch.norm|Yes|Supports bf16, fp16, fp32, fp64<br>When Parameter p is negative, the Computation Result May Exist precision errors<br>When Parameter dim specifies an axis with a shape dimension value of 1 in the input tensor, the Computation Result May Exist precision errors|
...
|torch.std|Yes|May Fall Back to CPU Execution|
|torch.std_mean|No|-|
|torch.sum|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool<br>dtype Parameter Not Supported|
|torch.unique|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool<br>fp16 Not Supported in dim scenarios<br>When the input contains 0, the output may include both positive 0 and negative 0 instead of only one 0|
|torch.unique_consecutive|No|-|
...
|torch.eq|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.equal|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool|
|torch.ge|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.greater_equal|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.gt|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
...
|torch.isin|Yes|Constraints for dual-tensor input scenarios:<br>- Supports fp16, fp32, uint8, int8, int16, int32, int64<br>- The first input tensor Number of Dimensions cannot be Greater Than 7, and the second input tensor Number of Dimensions cannot be Greater Than 8<br>Constraints for single-tensor input scenarios:<br>- Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64<br>- The input tensor Number of Dimensions is Not Greater Than 8|
...
|torch.le|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.less_equal|Yes|Supports fp16, fp32, fp64, uint8, int8, int16, int32, int64|
|torch.lt|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.less|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.maximum|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.minimum|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.ne|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.not_equal|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128|
|torch.sort|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64|
|torch.topk|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64<br>sorted=False scenario Not Supported|
...
|torch.hann_window|Yes|Supports bf16, fp16, fp32<br>When Data Type is fp32 and Parameter window_length is Greater Than 10000, the Computation Result May Exist errors|
...
|torch.bincount|Yes|Supports uint8, int8, int16, int32, int64<br>weights Number of Dimensions must be consistent with input Number of Dimensions|
...
|torch.cdist|Yes|Supports bf16, fp16, fp32<br>When p=2.0, "compute_mode" only supports "donot_use_mm_for_euclid_dist" mode; passing other values will be automatically changed to this mode|
...
|torch.cummin|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64, bool<br>When input is int32, the value range is within [-16777216, 16777216]|
|torch.cumprod|Yes|Supports bf16, fp16, fp32, fp64, uint8, int8, int16, int32, int64|
|torch.cumsum|Yes|Supports fp16, fp32, uint8, int8, int16, int32, int64, bool, complex64, complex128<br>Supports Named Tensor|
...
|torch.kron|Yes|Inputs with 5 or more dimensions Not Supported|
|torch.histc|Yes|Supports fp16, fp32<br>When input tensor values fall on bin boundaries, whether they are counted in the left bin or the right bin May Exist errors|
...
|torch.repeat_interleave|Yes|Supports fp16, fp32, int16, int32, int64, bool<br>After the input tensor is repeated to produce the output, the Number of Elements in the output must be less than $2^{22}$|
|torch.roll|Yes|Supports fp16, fp32, int32, int64, bool|
|torch.searchsorted|Yes|Supports fp16, fp32, fp64, uint8, int8, int16, int32, int64|
|torch.tensordot|Yes|Supports fp16, fp32|
|torch.tril|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
|torch.tril_indices|Yes|-|
|torch.triu|Yes|Supports bf16, fp16, fp32, uint8, int8, int16, int32, int64, bool|
...
|torch.addmm|Yes|Supports fp16, fp32|
...
|torch.bmm|Yes|Supports fp16, fp32|
|torch.dot|Yes|Supports bf16, fp16, fp32, uint8, int8, int32|
|torch.slogdet|Yes|Supports fp32, complex64, complex128<br>May Fall Back to CPU Execution|
|torch.matmul|Yes|Supports fp16, fp32<br>Supports Named Tensor<br>Input supports up to 6 dimensions|
|torch.mm|Yes|Supports fp16, fp32|
...
|torch.compile|Yes|Backend supports npugraphs, with overall functionality consistent with backend="cudagraphs"|
