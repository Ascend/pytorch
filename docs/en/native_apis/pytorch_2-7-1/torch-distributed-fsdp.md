...
|--|--|--|
|torch.distributed.fsdp.FullyShardedDataParallel|Yes|Supports bf16, fp16, fp32<br>When using FSDP in Ascend NPU scenarios, it is recommended to pass the device-related parameter "device_id=torch.device("npu:0")"|
