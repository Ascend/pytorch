...
|--|--|--|
|torch.distributed.GradBucket|Yes|FP32 supported|
|torch.distributed.GradBucket.index|Yes|FP32 supported|
|torch.distributed.GradBucket.buffer|Yes|FP32 supported|
|torch.distributed.GradBucket.gradients|Yes|FP32 supported|
...
|torch.distributed.algorithms.ddp_comm_hooks.default_hooks.allreduce_hook|Yes|FP32 supported|
|torch.distributed.algorithms.ddp_comm_hooks.default_hooks.fp16_compress_hook|Yes|FP32 supported|
|torch.distributed.algorithms.ddp_comm_hooks.default_hooks.bf16_compress_hook|Yes|-|
|torch.distributed.algorithms.ddp_comm_hooks.default_hooks.fp16_compress_wrapper|Yes|FP32 supported|
...
|torch.distributed.algorithms.ddp_comm_hooks.debugging_hooks.noop_hook|Yes|FP32 supported|
