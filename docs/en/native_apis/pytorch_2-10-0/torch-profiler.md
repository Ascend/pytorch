...
<!-- md-trans-meta sourceCommit=unknown translatedAt=2026-06-14T07:59:06.512Z pushedAt=2026-06-14T09:16:34.770Z -->
...
>
> When using supported profiler interfaces, you need to replace the API name with the **NPU Form Name**. The supported NPU-form profiler APIs are listed in the table below.
