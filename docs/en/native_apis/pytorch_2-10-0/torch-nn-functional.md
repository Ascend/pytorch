...
|torch.nn.functional.max_pool2d|Yes|Supports bf16, fp16, fp32<br>By setting torch_npu.npu.use_compatible_impl(True), memory consistency is aligned with the community counterpart interface|
...
|torch.nn.functional.max_unpool2d|Yes|Supports fp16, fp32, fp64, uint8, int8, int32, int64<br>When jit_compile=False, i.e., in binary mode, the product of output_size must be greater than or equal to the product of H and W of the input|
...
|torch.nn.functional.fractional_max_pool2d|Yes|Fallback to CPU execution|
...
|torch.nn.functional.hardswish|Yes|Supports fp16, fp32<br>Fallback to CPU execution|
...
|torch.nn.functional.batch_norm|Yes|Supports fp16, fp32<br>weight and bias only support 1-dimensional scenarios<br>The shape of bias is 1-dimensional, and its length equals the length of the channel axis in the input parameter|
...
|torch.nn.functional.poisson_nll_loss|Yes|Supports bf16, fp16, fp32, int64<br>Fallback to CPU execution|
