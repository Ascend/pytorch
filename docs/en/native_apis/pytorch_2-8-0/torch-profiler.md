...
<!-- md-trans-meta sourceCommit=e6dd39e7131a89f72cf49d80d53002e4cc645bbf translatedAt=2026-07-09T08:33:10.520Z pushedAt=2026-07-09T08:44:08.306Z -->

> [!NOTE]
> If the "Supported" column is "Yes" and "Restrictions and Notes" is "-", it means the API support is consistent with the native API.
>
> When using supported profiler APIs, you need to replace the API name with the NPU-adapted name. The supported NPU form profiler APIs are listed in the following table.
