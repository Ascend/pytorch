...
<!-- md-trans-meta sourceCommit=e6dd39e7131a89f72cf49d80d53002e4cc645bbf translatedAt=2026-07-09T08:35:18.632Z pushedAt=2026-07-09T08:44:08.336Z -->
...
|torch.range|Yes|-|
|torch.linspace|Yes|Supports bf16, fp16, fp32, fp64, int16, int32, int64, bool, complex64, complex128<br>Creates a 1-D vector with the sequence size equal to steps|
...
|torch.logit|Yes|Supports bf16, fp16, fp32<br>When eps is greater than 1, the output is nan; when eps equals 1, the output is inf|
...
|torch.histc|Yes|Supports fp16, fp32<br>When the input tensor value falls on the boundary between counting intervals, there may be errors in whether it is counted in the left interval or the right interval|
