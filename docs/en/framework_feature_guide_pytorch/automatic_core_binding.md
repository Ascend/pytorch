...
<!-- md-trans-meta sourceCommit=unknown translatedAt=2026-06-15T07:48:59.197Z pushedAt=2026-06-15T12:00:44.065Z -->
...
![figure 1](../figures/thread_core_binding_principle.png)

## Use Scenario

It is recommended to use this feature in scenarios where host task dispatch is slow or service latency fluctuates significantly between cards.
...
- Coarse-grained core binding example:

    ```shell
    export CPU_AFFINITY_CONF=1
    ```

- Fine-grained core binding example:
...
- NPU affinity core binding example:

    ```shell
    export CPU_AFFINITY_CONF=1,npu_affine:1
    ```

- Forced core binding example in container core isolation scenario:
