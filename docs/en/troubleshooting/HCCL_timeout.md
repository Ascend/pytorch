...
Based on the error code **EI0002**, for details, see the Communication Operation Timeout (EI0002) section in the *HCCL User Guide* for troubleshooting guidance.
<!-- see the [Communication Operation Timeout (EI0002)](https://www.hiascend.com/document/detail/en/canncommercial/83RC1/hccl/hcclug/hcclug_000031.html) section in the *HCCL User Guide* for troubleshooting guidance.-->
