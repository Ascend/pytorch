...
**The overall fault handling process mainly includes the following procedures: collecting fault information, analyzing fault causes, troubleshooting, and recording the fault handling process**. The specific implementation process is shown in [Figure 1](#figure1).

**Figure 1**  Fault handling process<a id="figure1"></a>  
![figure1](../figures/troubleshooting_process.png "Fault handling process")
...
- Refer to **Error Code** handling
    ...
    <!-- see the "[Error Code Reference](https://www.hiascend.com/document/detail/en/CANNCommunityEdition/910/maintenref/troubleshooting/troubleshooting_0225.html)" section in *CANN Troubleshooting*.-->

    For details about the error codes of the TorchNPU plugin, see [Error Code Introduction](error_codes_introduction.md).

- Collecting fault information

    Fault information is an important basis for fault handling. Fault handling personnel should collect as much fault information as possible, including but not limited to logs, environment information, and so on.
    ...
    <!-- see the "[Setting Log Levels](https://www.hiascend.com/document/detail/en/CANNCommunityEdition/910/maintenref/logreference/logreference_0008.html)" section in the *CANN Log Reference*.-->

    For a detailed introduction to log paths and log files, see the "Viewing Logs (Ascend EP)" section in the *CANN Log Reference*.
    <!-- see the "[Viewing Logs (Ascend EP)](https://www.hiascend.com/document/detail/en/CANNCommunityEdition/910/maintenref/logreference/logreference_0002.html)" section in the *CANN Log Reference*.-->
    ...
    Use the msnpureport tool to transfer system logs from the Device side to the Host side for viewing. For details, see [msnpureport Tool Usage](https://support.huawei.com/enterprise/en/ascend-computing/atlas-800t-a2-pid-254184887?category=reference-guides).
