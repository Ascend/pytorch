...
2. Add the following code to `train.py`.
    ...
    - If you are using Atlas training series products, you need to enable mixed precision after the migration is complete and before training begins, due to their architectural characteristics.
    - If you are using Atlas A2 training series products, Atlas A3 training series products, or Ascend 950DT, you can choose whether to enable mixed precision.

    > [!NOTE]
    >
    > For details, see [Mixed Precision Adaptation](https://gitcode.com/Ascend/ModelZoo-PyTorch/blob/master/PyTorch/docs/en/mixed_precision_adaptation/adaptation_introduction.md).
    ...
    If automatic migration is not enabled, refer to [Manual Migration](https://gitcode.com/Ascend/ModelZoo-PyTorch/blob/master/PyTorch/docs/en/model_migration/manual_migration.md) for related operations.

3. Enable AMP mixed precision computation. If you are using Atlas A2 training series products, Atlas A3 training series products, or Ascend 950DT, you can choose to skip this step.
...
- If you want to explore more features of PyTorch model training migration, go to the [PyTorch Training Model Migration and Tuning Guide](https://gitcode.com/Ascend/ModelZoo-PyTorch/blob/master/PyTorch/docs/en/README.md) document for details.
- If you want to explore more features of large model training, see [Table 1](#table1) for details.

    **Table 1**  Model migration guide<a id="table1"></a>
