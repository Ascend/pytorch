...
struct TORCH_NPU_CPP_API NPUGeneratorImpl : public c10::GeneratorImpl {
  // Constructors
...
namespace npu {
namespace detail { 
TORCH_NPU_CPP_API const Generator& getDefaultNPUGenerator(
    DeviceIndex device_index = -1);
TORCH_NPU_CPP_API Generator createNPUGenerator(DeviceIndex device_index = -1);
