...
if(USE_HCCL)
  target_link_libraries(npu_interface INTERFACE acl_op_compiler ascendcl hccl python3.7m)
else()
  target_link_libraries(npu_interface INTERFACE acl_op_compiler ascendcl python3.7m)
endif()