...
| Huawei-developed         | Not involved.                                                                                                                                                                                                                  | test\\requirements.txt                  | https://data.pyg.org/whl/torch-2.4.0+cpu.html                                  | Download link, which is used to download the CPU version of torch-scatter.                           |
