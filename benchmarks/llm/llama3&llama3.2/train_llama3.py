...
class LLama3Trainer:
    ...
    def setup_training(self):
        logger.info("Loading model from %s", self.args.model_path)
    ...
    def get_lora_target_modules(self):
        ...
        logger.info("Using LoRA target modules: %s", available_modules)
    ...
    def create_trainer(self, train_dataset, eval_dataset=None):
        ...
        if self.args.enable_profiler:
            profiling_save_path = self.args.profiler_save_path + '/' + self.args.model_name + '/' + mod
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./llama3-finetuned",
    ...
    parser.add_argument("--model_name", type=str, default="llama3-8B", help="your model name")
    ...
    print(f"{args.device_type}  train  {args.model_name}")
    trainer = LLama3Trainer(args)
