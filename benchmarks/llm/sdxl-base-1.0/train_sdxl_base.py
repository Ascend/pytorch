...
class SDXLLoRAFineTuner:
    ...
    def setup_model(self):
        logger.info("Loading SDXL model from %s", self.args.model_path)
        ...
        logger.info("Trainable params: %s", sum(p.numel() for p in params_to_optimize))
    ...
    def train(self):
        ...
        logger.info("Saving LoRA weights to %s", self.args.output_dir)
