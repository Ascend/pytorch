...
class GLM4Trainer:
    ...
    def setup_training(self):
        logger.info(f"Loading GLM-4 model from {self.args.model_path}")
    ...
    def get_lora_target_modules(self):
        ...
        if not available_modules:
            ...
            logger.warning(f"No avaliable, GLM-4 using LoRA target modules: {available_modules}")
        else:
            logger.info(f"GLM-4 LoRA target modules: {available_modules}")
