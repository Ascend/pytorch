...
class Baichuan2Trainer:
    ...
    def setup_training(self):
        logger.info("Loading model/tokenizer from %s", self.args.model_path)
    ...
    def load_and_preprocess_data(self) -> Dataset:
        ...
        logger.info("Dataset size: %s", len(processed))
        return processed
    ...
    def train(self):
        ...
        if self.args.enable_compile:
            ...
            try:
                ...
                logger.exception("torch.compile failed. Continue without compile.")
...
def main():
    ...
    logger.info("npu train %s", MODEL_NAME)
