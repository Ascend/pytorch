...
class ProfilerConfig:
    LEVEL_PARSER_CONFIG = {
        ...
        Constant.LEVEL1: [(CANNDataEnum.NPU_MODULE_MEM, NpuModuleMemoryBean)],
        Constant.LEVEL2: [(CANNDataEnum.AI_CPU, AiCpuBean), (CANNDataEnum.NPU_MODULE_MEM, NpuModuleMemoryBean)]
    }
