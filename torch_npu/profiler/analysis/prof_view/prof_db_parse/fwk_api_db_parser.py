    ...
    def get_api_data_for_db(self, fwk_api_data: dict):
        ...
        for torch_op_api in torch_op_apis:
            self._fwk_apis.append([torch_op_api[TorchOpDataOri.START_NS.value],
                                   ...
                                   None if not torch_op_api[TorchOpDataOri.CALL_STACK.value] else CallChainIdManager().get_callchain_id_from_callstack(torch_op_api[TorchOpDataOri.CALL_STACK.value]), ApiType.TORCH_OP.value])
