...
c10::intrusive_ptr<c10::ivalue::Future> FP16CompressCommHook::runHook(GradBucket& bucket) {
  ...
  auto decompress = [decompressed_tensor](c10::ivalue::Future& allreduce_fut) {
    ...
    TORCH_INTERNAL_ASSERT(
        result.isTensorList(), "ProcessGroup::allreduce should return TensorList", DIST_ERROR(ErrCode::INTERNAL));
