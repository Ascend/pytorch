 ...
 public:
  ...
  void finish() {
    ...
    TORCH_INTERNAL_ASSERT(
        output_tensors.size() == bucket_tensors_.size(),
...
PyObject* c10d_npu_init(PyObject* _unused, PyObject* noargs) {
  ...
  auto m = torch_npu_C_m.def_submodule(
      "_distributed_c10d", "distributed c10d bindings");
  ...
  module.def(
      ...
      [](const c10::intrusive_ptr<::c10d::ProcessGroup>& process_group,
        ...
        if (logger.has_value()) {
          std::weak_ptr<::c10d::Logger> logger_weakref = logger.value();
          c10d_npu::verify_params_across_processes(
  ...
  shared_ptr_class_<c10d_npu::Reducer>(module, "Reducer")
      ...
      .def(
          "prepare_for_backward",
          [](c10d_npu::Reducer& reducer, const at::Tensor& output) -> void {
  ...
  auto processGroupHCCL =
      intrusive_ptr_no_gil_destructor_class_<::c10d_npu::ProcessGroupHCCL>(
          ...
          .def(
              "_set_hccl_comm_name",
              &::c10d_npu::ProcessGroupHCCL::setHcclCommName)
          .def(
              "resume_hccl_comm", &::c10d_npu::ProcessGroupHCCL::resumeHcclComm)
          .def(
          ...
          .def(
              "abort_hccl_comm",
              &::c10d_npu::ProcessGroupHCCL::abortAndClearHcclComm)
          .def(
              "_delete_tcpstore_key",
              &::c10d_npu::ProcessGroupHCCL::deleteTCPStoreKey)
          .def(
              "set_watchdog_status",
              &::c10d_npu::ProcessGroupHCCL::setWatchdogStatus)
          .def(
              "clear_workmeta_list",
              &::c10d_npu::ProcessGroupHCCL::clearWorkMetaList)
          .def(
              "get_hccl_comm_name",
          ...
          .def(
              "get_coll_stream_id",
              &::c10d_npu::ProcessGroupHCCL::getCollStreamId,
              py::arg("device"))
          .def(
              "get_p2p_stream_id",
          ...
          .def_property_readonly(
              "options", &::c10d_npu::ProcessGroupHCCL::getOptions)
          .def(
              "batch_isend_irecv",
              [](::c10d_npu::ProcessGroupHCCL& pg,
          ...
          .def(
              "_group_start",
              &::c10d_npu::ProcessGroupHCCL::groupStart,
              py::call_guard<py::gil_scoped_release>())
          .def(
              "_group_end",
              &::c10d_npu::ProcessGroupHCCL::groupEnd,
              py::call_guard<py::gil_scoped_release>());
  ...
  intrusive_ptr_class_<::c10d_npu::ProcessGroupHCCL::Options>(
      ...
      .def(py::init<>())
      .def_readwrite(
          "op_timeout", &::c10d_npu::ProcessGroupHCCL::Options::opTimeout)
      .def_readwrite(
      ...
      .def_readwrite(
          "hccl_config", &::c10d_npu::ProcessGroupHCCL::Options::hccl_config)
      .def_readwrite(
          "group_id", &::c10d_npu::ProcessGroupHCCL::Options::group_id);
  ...
  auto parallelStore =
      intrusive_ptr_no_gil_destructor_class_<::c10d::ParallelTcpStore>(
          ...
          .def(
              py::init([](const std::string& host,
                ...
                ::c10d::TCPStoreOptions opts{
                    ...
                    timeout,
                    multiTenant};
                return c10::make_intrusive<::c10d::ParallelTcpStore>(
