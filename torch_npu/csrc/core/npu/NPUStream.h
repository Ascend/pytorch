...
C10_NPU_API NPUStream
getStreamFromExternal(aclrtStream stream, c10::DeviceIndex device_index);

C10_NPU_API NPUStream
getStreamFromPool(const bool isHighPriority, c10::DeviceIndex device_index);
