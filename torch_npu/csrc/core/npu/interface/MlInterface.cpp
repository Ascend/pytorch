...
AmlStatus AmlAicoreDetectOnlineFace(
    int32_t deviceId,
    const AmlAicoreDetectAttr* attr) {
  typedef AmlStatus (*amlAicoreDetectOnline)(
      int32_t, const AmlAicoreDetectAttr*);
...
AmlStatus AmlP2PDetectOnlineFace(
    int32_t deviceId,
    void* comm,
    const AmlP2PDetectAttr* attr) {
  typedef AmlStatus (*amlP2PDetectOnline)(
      int32_t, void*, const AmlP2PDetectAttr*);
