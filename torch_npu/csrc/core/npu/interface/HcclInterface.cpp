...
extern HcclResult HcclCommResumeFace(HcclComm comm) {
  ...
  TORCH_CHECK(
      func,
      "Failed to find function HcclCommResume,"
      " maybe you cann version is too low, please upgrade it",
...
HcclResult HcclCommSetMemoryRangeFace(HcclComm comm, void* virPtr, size_t size, size_t alignment, uint64_t flags) {
  ...
  TORCH_CHECK(
      func,
      "Failed to find function HcclCommSetMemoryRange,"
      " maybe you cann version is too low, please upgrade it",
      DIST_ERROR(ErrCode::NOT_FOUND));
...
HcclResult HcclCommUnsetMemoryRangeFace(HcclComm comm, void* virPtr) {
  ...
  TORCH_CHECK(
      func,
      "Failed to find function HcclCommUnsetMemoryRange,"
      " maybe you cann version is too low, please upgrade it",
      DIST_ERROR(ErrCode::NOT_FOUND));
...
HcclResult HcclCommActivateCommMemoryFace(
  ...
  TORCH_CHECK(
      func,
      "Failed to find function HcclCommActivateCommMemory,"
      " maybe you cann version is too low, please upgrade it",
      DIST_ERROR(ErrCode::NOT_FOUND));
...
HcclResult HcclCommDeactivateCommMemoryFace(HcclComm comm, void* virPtr) {
  ...
  TORCH_CHECK(
      func,
      "Failed to find function HcclCommDeactivateCommMemory,"
      " maybe you cann version is too low, please upgrade it",
      DIST_ERROR(ErrCode::NOT_FOUND));
  return func(comm, virPtr);
}
