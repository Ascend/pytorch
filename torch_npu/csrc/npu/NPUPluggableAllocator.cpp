...
void NPUPluggableAllocator::emptyCache(c10_npu::MempoolId_t mempool_id) {
  TORCH_NPU_WARN(
      "NPUPluggableAllocator does not yet support emptyCache with mempool_id. "
      "If you need it, please file an issue describing your use case.");
}
...
void NPUPluggableAllocator::emptyVirtAddrCache(bool check_error) {
  TORCH_NPU_WARN(
      "NPUPluggableAllocator does not yet support emptyVirtAddrCache. "
      "If you need it, please file an issue describing your use case.");
}
...
void* NPUPluggableAllocator::getBlockPtr(const c10::DataPtr& ptr) {
  TORCH_NPU_WARN(
      "NPUPluggableAllocator does not yet support getBlockPtr. "
      "If you need it, please file an issue describing your use case.");
  return nullptr;
}
