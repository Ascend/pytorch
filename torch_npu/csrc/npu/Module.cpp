...
PyObject* THNPModule_tensor_construct_from_storage(PyObject* self, PyObject* args) {
  ...
  at::ScalarType dtype = is_typed_storage ? storage_scalar_type : at::ScalarType::Undefined;
  return THPVariable_Wrap(at_npu::native::set_tensor_with_storage_format(storage, dtype));
