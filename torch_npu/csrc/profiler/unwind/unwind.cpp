...
#include "torch_npu/csrc/profiler/unwind/unwind.h"
...
#include "torch_npu/csrc/profiler/unwind/communicate.h"
#include "torch_npu/csrc/profiler/unwind/eh_frame_hdr.h"
#include "torch_npu/csrc/profiler/unwind/fde.h"
#include "torch_npu/csrc/profiler/unwind/unwinder.h"
...
struct LibraryInfo {
    ...
    Unwinder unwinderFor(uint64_t addr) const
    {
        ...
        FDE<false> fde(fde_data, name().c_str(), load_bias());
