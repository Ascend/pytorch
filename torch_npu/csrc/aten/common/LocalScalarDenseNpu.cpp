...
c10::Scalar NPUNativeFunctions::_local_scalar_dense(const at::Tensor& self)
{
    ...
    AT_DISPATCH_V2(
        self.scalar_type(), "_local_scalar_dense_npu", AT_WRAP([&] {
            ...
            r = c10::Scalar(value);
        }), AT_EXPAND(AT_ALL_TYPES_AND_COMPLEX), at::ScalarType::Half, at::ScalarType::Bool, at::ScalarType::BFloat16, AT_EXPAND(AT_FLOAT8_TYPES), AT_EXPAND(AT_BAREBONES_UNSIGNED_TYPES));
    return r;
}
