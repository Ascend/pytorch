...
namespace at_npu {
namespace native {
at::Tensor& histc_out_nocheck(const at::Tensor& self, int64_t bins, const at::Scalar& min, 
...
at::Tensor& NPUNativeFunctions::histc_out(const at::Tensor& self, int64_t bins, const at::Scalar& min, 
                                          const at::Scalar& max, at::Tensor& result) {
...
at::Tensor NPUNativeFunctions::histc(const at::Tensor& self, int64_t bins, const at::Scalar& min, 
                                     const at::Scalar& max) {
