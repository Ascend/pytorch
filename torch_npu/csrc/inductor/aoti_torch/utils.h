...
inline std::optional<at::Tensor> resolve_tensor_dispatch_flags(const AtenTensorHandle* handle)
{
    return handle ? std::make_optional(resolve_tensor_dispatch_flags(*handle)) : std::nullopt;
}

inline std::vector<at::Tensor> resolve_tensor_list_dispatch_flags(const AtenTensorHandle* handle, int64_t len)
{
...
inline std::vector<std::optional<at::Tensor> > resolve_tensor_list_dispatch_flags(const AtenTensorHandle** handle,
                                                                                  int64_t len)
{
...
inline at::Generator* generator_handle_to_generator_pointer(AtenGeneratorHandle handle)
{
    return reinterpret_cast<at::Generator*>(handle);
}

inline AtenGeneratorHandle generator_pointer_to_generator_handle(at::Generator* generator)
{
...
inline void assert_inf_and_nan(const std::string& tensor_name, at::Tensor& check_tensor)
{
...
template <class T> inline std::optional<T> pointer_to_optional(T* ptr)
{
...
template <> inline std::optional<at::Tensor> pointer_to_optional(AtenTensorHandle* ptr)
{
    return ptr ? std::make_optional(*tensor_handle_to_tensor_pointer(*ptr)) : std::nullopt;
}

template <> inline std::optional<at::Tensor> pointer_to_optional(const AtenTensorHandle* ptr)
{
    return ptr ? std::make_optional(*tensor_handle_to_tensor_pointer(*ptr)) : std::nullopt;
}

template <> inline std::optional<at::Generator> pointer_to_optional(AtenGeneratorHandle* ptr)
{
    return ptr ? std::make_optional(*generator_handle_to_generator_pointer(*ptr)) : std::nullopt;
}

inline std::optional<c10::Device> pointer_to_optional_device(int32_t* device_type, int32_t device_index)
{
    return device_type ? std::make_optional(c10::Device(static_cast<c10::DeviceType>(*device_type),
...
template <class T> inline c10::ArrayRef<T> pointer_to_list(T* ptr, int64_t len) { return c10::ArrayRef<T>(ptr, len); }
...
template <> inline std::vector<at::Tensor> pointer_to_list(const AtenTensorHandle* ptr, int64_t len)
{
...
template <> inline std::vector<std::optional<at::Tensor> > pointer_to_list(const AtenTensorHandle** ptr, int64_t len)
{
...
template <int N> inline std::array<bool, N> pointer_to_list(const int32_t* ptr)
{
...
template <class T, class U> inline std::optional<c10::ArrayRef<T> > pointer_to_optional_list(U** ptr, int64_t len)
{
    return ptr ? std::make_optional<c10::ArrayRef<T> >(pointer_to_list<T>(*ptr, len)) : std::nullopt;
}
