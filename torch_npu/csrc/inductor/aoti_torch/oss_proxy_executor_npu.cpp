...
void OSSProxyExecutorNpu::prefill_stack_with_static_arguments(size_t index, const at::TypePtr& schema_arg_type,
...
void OSSProxyExecutorNpu::get_input_info_from_serialized(const std::vector<c10::Argument>& schema_args,
...
void OSSProxyExecutorNpu::get_output_info_from_serialized(const std::vector<c10::Argument>& schema_returns,
                                                          const nlohmann::json& serialized_node, OSSOpKernel& op_kernel)
{
...
OSSProxyExecutorNpu::OSSProxyExecutorNpu(const std::string& json_path, bool is_cpu)
{
    if (is_cpu) {
...
void OSSProxyExecutorNpu::call_function(int extern_node_index, int num_ints, int64_t* flatten_int_args, int num_tensors,
