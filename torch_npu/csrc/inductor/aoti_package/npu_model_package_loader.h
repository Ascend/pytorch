...
class TORCH_API NPUAOTIModelPackageLoader {
public:
    NPUAOTIModelPackageLoader(const std::string &model_package_path);
    NPUAOTIModelPackageLoader(const std::string &model_package_path, const std::string &model_name);
    ~NPUAOTIModelPackageLoader();
