...
struct DTypeConstants {
  ...
  static const int float8_e8m0fnu_value;
  static const int float6_e3m2_value;
  static const int float6_e2m3_value;
  static const int float4_e2m1fn_x2_value;
  static const int float4_e1m2fn_x2_value;
};
...
const std::string CustomDataTypeToString(int64_t dType) {
  ...
  const std::map<const DType, const std::string> TYPE_TO_STRING_MAP = {
      ...
      {DType::FLOAT8_E8M0, "torch_npu.float8_e8m0fnu"},
      {DType::FLOAT6_E3M2, "torch_npu.float6_e3m2"},
      {DType::FLOAT6_E2M3, "torch_npu.float6_e2m3"},
      {DType::FLOAT4_E2M1, "torch_npu.float4_e2m1fn_x2"},
      {DType::FLOAT4_E1M2, "torch_npu.float4_e1m2fn_x2"}};
