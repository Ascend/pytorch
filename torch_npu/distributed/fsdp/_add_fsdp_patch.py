from typing import Any, Tuple, Union, cast, List, Dict, Optional
import logging
...
def _patched_foreach_reduce(
    ...
    with device_handle.stream(reduce_scatter_stream):
        ...
        if reduce_scatter_reduce_op == ReduceOp.PREMUL_SUM:
            factor = 1.0 / reduce_scatter_reduce_op.__getstate__()[1]
