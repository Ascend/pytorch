...
需要注意的是，当安装的torch_npu版本为2.7.1及之后版本，均可正常使用Inductor Ascend，对于其他torch_npu版本请参见对应版本文档中的安装介绍。
...
**安装指南：** [Catlass快速开始指南](https://gitcode.com/cann/catlass/blob/master/docs/zh/1_Practice/01_quick_start.md)
