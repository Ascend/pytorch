...
@SymbolicGridFn
def flex_decoding_npu_grid(batch_size, kv_heads, gqa_group_size, seq_len_q, d_model, meta):
    num_block_m = (
        seq_len_q * gqa_group_size + meta["BLOCK_M"] - 1
    ) // meta["BLOCK_M"]
...
flex_decoding_npu_source = r"""
    ...
    q_m = q_rows % BLOCK_M_PER_HQ + off_block_m * BLOCK_M_PER_HQ
    q_range = (
    ...
    {{store_output(("idx_z", "idx_t", "idx_hq", "idx_m", "idx_d"),
    "acc", "mask", val_shape=("GQA_SHARED_HEADS", "BLOCK_M_PER_HQ", "V_HEAD_DIM_ROUNDED"))}}
...
flex_decoding_npu.always_freeze_layout = True
