...
def add_npu_triton_mm_choices(
    ...
    for cfg in configs:
        ...
        try:
            ...
            log.debug(
                "Failed to generate NPU triton mm choice with config %s",
                cfg,
                exc_info=True,
            )
...
def add_npu_persistent_mm_choices(
    ...
    for cfg in configs:
        ...
        try:
            ...
            log.debug(
                "Failed to generate NPU persistent mm choice with config %s",
                cfg,
                exc_info=True,
            )
...
def add_npu_triton_addmm_choices(
    ...
    for cfg in configs:
        ...
        try:
            ...
            log.debug(
                "Failed to generate NPU triton addmm choice with config %s",
                cfg,
                exc_info=True,
            )
    ...
    def tuned_mm(mat1, mat2, *, layout=None):
        ...
        if is_nonzero and use_triton_template(layout):
            try:
                ...
                log.warning("Failed to add NPU triton mm template choices", exc_info=True)
        ...
        if is_nonzero and use_triton_template(layout):
            try:
                ...
                log.warning("Failed to add NPU persistent mm template choices", exc_info=True)
    ...
    def tuned_addmm(inp, mat1, mat2, *, alpha=1, beta=1, layout=None):
        ...
        if is_nonzero and use_triton_template(layout):
            try:
                ...
                log.warning("Failed to add NPU triton addmm template choices", exc_info=True)
