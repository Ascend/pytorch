...
from torch._inductor.select_algorithm import autotune_select_algorithm, realize_inputs, TritonTemplate  # noqa: F401
from torch._inductor.kernel.flex.flex_decoding import create_flex_decoding_kernel
from torch._inductor.kernel.flex.flex_attention import (  # noqa: F401
    lower_cpu,
    maybe_realize,
    create_placeholder,
    set_head_dim_values,
...
from torch._inductor.kernel.flex.common import (  # noqa: F401
    is_power_of_2,
    next_power_of_two,
    construct_strides,
)
...
def _get_flex_attention_additional_lowerings():
    ...
    from torch._inductor.subgraph_lowering import PointwiseSubgraphLowering  # noqa: F401
