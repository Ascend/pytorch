...
|   开源引入   |   https://github.com/pytorch/pytorch/blob/release/2.4/test/onnx/test_utility_funs.py   |   test\url.ini   |   https://github.com/pytorch/pytorch/issues/new?template=bug-report.yml   | issue的链接                       |
...
|   自研   |   不涉及  |   test\requirements-x86.txt   |   https://download.pytorch.org/whl/test/cpu    |   下载链接，用于下载torch-cpu版本   |
