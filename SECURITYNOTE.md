...
| 自研   | 不涉及                                                                                                                                                                                                                            | test\requirements.txt                  | https://data.pyg.org/whl/torch-2.6.0+cpu.html                                  | 下载链接，用于下载torch-scatter的cpu版本   |
...
| 开源引入 | https://gitee.com/mirrors/pytorch/blob/v2.6.0/third_party/miniz-3.0.2/miniz.h                                                                                                                                                    | build_libtorch_npu.py <br> setup.py                  | https://gitee.com/mirrors/pytorch/raw/v2.6.0/third_party/miniz-3.0.2/miniz.h     | 下载链接，用于下载miniz库                |
## 公开接口声明
