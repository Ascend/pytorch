...
#include "ops/ascend/aclnn/pow_tensor.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnPowTensor::CalcWorkspace(
...
OpsErrorCode AclnnPowTensor::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(pow_tensor, AclnnPowTensor, Ascend);
FXRT_REG_OP_PROTOTYPE(pow_tensor, 2);
} // namespace ops
} // namespace fxrt
