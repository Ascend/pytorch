...
#include "ops/ascend/aclnn/le_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnLeScalar::CalcWorkspace(
...
OpsErrorCode AclnnLeScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(le_scalar, AclnnLeScalar, Ascend);
} // namespace ops
} // namespace fxrt
