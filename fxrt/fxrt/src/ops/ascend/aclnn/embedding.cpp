...
#include "ops/ascend/aclnn/embedding.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnEmbedding::CalcWorkspace(
...
OpsErrorCode AclnnEmbedding::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(embedding, AclnnEmbedding, Ascend);
FXRT_REG_OP_PROTOTYPE(embedding, 2);
} // namespace ops
} // namespace fxrt
