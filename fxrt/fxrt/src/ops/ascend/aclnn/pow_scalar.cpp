...
#include "ops/ascend/aclnn/pow_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnPowScalar::CalcWorkspace(
...
OpsErrorCode AclnnPowScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(pow_scalar, AclnnPowScalar, Ascend);
} // namespace ops
} // namespace fxrt
