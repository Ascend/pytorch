...
#include "ops/ascend/aclnn/lt_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnLtScalar::CalcWorkspace(
...
OpsErrorCode AclnnLtScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(lt_scalar, AclnnLtScalar, Ascend);
} // namespace ops
} // namespace fxrt
