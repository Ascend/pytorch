...
#include "ops/ascend/aclnn/ge_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnGeScalar::CalcWorkspace(
...
OpsErrorCode AclnnGeScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(ge_scalar, AclnnGeScalar, Ascend);
} // namespace ops
} // namespace fxrt
