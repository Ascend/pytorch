...
#include "ops/ascend/aclnn/neg.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnNeg::CalcWorkspace(
...
FXRT_REG_OP(neg, AclnnNeg, Ascend);
FXRT_REG_OP_PROTOTYPE(neg, 1);
} // namespace ops
} // namespace fxrt
