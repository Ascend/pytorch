...
#include "ops/ascend/aclnn/div_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnDivScalar::CalcWorkspace(
...
OpsErrorCode AclnnDivScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(div_scalar, AclnnDivScalar, Ascend);
} // namespace ops
} // namespace fxrt
