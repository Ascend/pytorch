...
#include "ops/ascend/aclnn/eq_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnEqScalar::CalcWorkspace(
...
OpsErrorCode AclnnEqScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(eq_scalar, AclnnEqScalar, Ascend);
} // namespace ops
} // namespace fxrt
