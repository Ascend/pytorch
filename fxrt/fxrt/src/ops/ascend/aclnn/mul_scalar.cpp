...
#include "ops/ascend/aclnn/mul_scalar.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnMulScalar::CalcWorkspace(
...
OpsErrorCode AclnnMulScalar::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(mul_scalar, AclnnMulScalar, Ascend);
} // namespace ops
} // namespace fxrt
