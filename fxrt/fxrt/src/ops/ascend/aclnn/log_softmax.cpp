...
#include "ops/ascend/aclnn/log_softmax.h"
#include "ops/op_register.h"

namespace fxrt {
namespace ops {

OpsErrorCode AclnnLogSoftmax::CalcWorkspace(
...
OpsErrorCode AclnnLogSoftmax::Launch(
    const std::vector<const ir::Value*>& input,
    void* workspace,
    size_t workspaceSize,
    ir::Value* output,
...
FXRT_REG_OP(log_softmax, AclnnLogSoftmax, Ascend);
} // namespace ops
} // namespace fxrt
