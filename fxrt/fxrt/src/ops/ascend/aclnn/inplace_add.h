#ifndef __OPS_ASCEND_ACLNN_ACLNN_INPLACE_ADD_H__
#define __OPS_ASCEND_ACLNN_ACLNN_INPLACE_ADD_H__
...
namespace fxrt {
namespace ops {
class AclnnInplaceAdd : public Operator {
 public:
  AclnnInplaceAdd() {
    executor_ = std::make_unique<AclnnExecutor>("aclnnInplaceAdd");
  }
  ~AclnnInplaceAdd() override = default;
...
#endif // __OPS_ASCEND_ACLNN_ACLNN_INPLACE_ADD_H__
