#ifndef __OPS_ASCEND_ACLNN_ACLNN_SCATTER_ND_UPDATE__H__
#define __OPS_ASCEND_ACLNN_ACLNN_SCATTER_ND_UPDATE__H__
...
#endif // __OPS_ASCEND_ACLNN_ACLNN_SCATTER_ND_UPDATE__H__
