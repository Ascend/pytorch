...
KNOWN_URLS = {
    ...
    (2, 14): (
        "https://download-r2.pytorch.org/whl/nightly/cpu/"
        "torch-2.14.0.dev20260811%2Bcpu-cp310-cp310-manylinux_2_28_aarch64.whl"
    ),
    (2, 15): (
        "https://download-r2.pytorch.org/whl/nightly/cpu/"
        "torch-2.15.0.dev20260816%2Bcpu-cp310-cp310-manylinux_2_28_aarch64.whl"
    ),
}
