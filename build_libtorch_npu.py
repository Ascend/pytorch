...
def copy_hpp():
    def get_src_py_and_dst():
        ...
        # Recursively copy the ACL include tree to the public include root, so
        # that source can use uniform <acl/...>, <aml/...>, <profiling/...>,
        # <graph/...> includes instead of third_party/acl/inc/...
